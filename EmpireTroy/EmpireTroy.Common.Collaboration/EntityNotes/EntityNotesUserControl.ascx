<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EntityNotesUserControl.ascx.cs" Inherits="EmpireTroy.Common.Collaboration.EntityNotes.EntityNotesUserControl"  %>
...
<dx:ASPxGridView ID="EntityNotesGridView" runat="server" AutoGenerateColumns="False"        
...
<asp:ObjectDataSource ID="EntityNotesDataSource" runat="server" InsertMethod="AddEntityNote" SelectMethod="GetEntityNotes" TypeName="EmpireTroy.Common.Collaboration.EntityNotes.EntityNotesViewModel" UpdateMethod="ModifyEntityNote">        
    <InsertParameters>        
