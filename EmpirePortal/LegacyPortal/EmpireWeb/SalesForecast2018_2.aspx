<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesForecast2.aspx.cs" Inherits="SalesForecast2" %>
            ...
            <telerik:RadGrid    ID="BasePartAttributesRadGrid" 
                ...
                <MasterTableView    DataSourceID="BasePartAttributesRadGridDataSource" 
                    ...
                    <Columns>
						...
						<Telerik:GridDateTimeColumn DataField="mid_model_year" DataFormatString="{0:d}" FilterControlAltText="Filter mid_model_year column" HeaderText="Mid-model Year" UniqueName="mid_model_year">
                            <ColumnValidationSettings>
                                <ModelErrorMessage Text="" />
                            </ColumnValidationSettings>
                        </Telerik:GridDateTimeColumn>
...
<Telerik:GridBoundColumn Aggregate="Sum" DataField="jan 2020" DataFormatString="{0:N0}" DataType="System.Decimal" FilterControlAltText="Filter jan 2020 column" FooterAggregateFormatString="{0:N0}" HeaderText="Jan 2020" ReadOnly="True" SortExpression="jan 2020" UniqueName="jan2020">
                        ...
                        <Telerik:GridBoundColumn Aggregate="Sum" DataField="aug 2020" DataFormatString="{0:N0}" DataType="System.Decimal" FilterControlAltText="Filter aug 2020 column" FooterAggregateFormatString="{0:N0}" HeaderText="Aug 2020" ReadOnly="True" SortExpression="aug 2020" UniqueName="aug20120">
                            <ColumnValidationSettings>
                                <ModelErrorMessage Text="" />
                            </ColumnValidationSettings>
                        </Telerik:GridBoundColumn>
            ...
            <asp:SqlDataSource ID="EmpireFactorRadGridDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:MONITORConnectionString %>"
                ...
                UpdateCommand="eeiuser.acctg_csm_sp_update_empire_factor2018" UpdateCommandType="StoredProcedure">
                <SelectParameters>
		    ...
		    <asp:Parameter Name="Jan2019" Type="Decimal" />
					...
					<asp:Parameter Name="Total_2023" Type="Decimal" />
					<asp:Parameter Name="Total_2024" Type="Decimal" />
					<asp:Parameter Name="Total_2025" Type="Decimal" />
                </UpdateParameters>
            </asp:SqlDataSource>
