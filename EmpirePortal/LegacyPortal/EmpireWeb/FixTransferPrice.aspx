        ...
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="id" Width="100%" Settings-HorizontalScrollBarMode="Visible">
            ...
            <Columns>
                ...
                <Columns>
                    ...
                    <dx:GridViewDataDateColumn FieldName="date_updated" Caption="Date Updated" Width="80"  SettingsHeaderFilter-Mode="List" PropertiesDateEdit-AllowNull="true"  VisibleIndex="7" CellStyle-HorizontalAlign="Center" CellStyle-BorderRight-BorderWidth="3">
            ...
            <Settings ShowFilterBar="Visible" UseFixedTableLayout="True" VerticalScrollableHeight="700" VerticalScrollBarMode="Visible" ShowHeaderFilterButton="True" ShowHeaderFilterBlankItems="true"  />
