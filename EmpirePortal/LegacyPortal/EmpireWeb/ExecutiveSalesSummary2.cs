...
public partial class ExecutiveSalesSummary2 : System.Web.UI.Page 
{
...
//} 
	...
	protected void SalesForecastVolumesProgramSalespersonSelected_NeedDataSource(object source, Telerik.Web.UI.GridNeedDataSourceEventArgs e)
	{
		...
		protected void FilterComboBox_SelectedIndexChanged(object o, Telerik.Web.UI.RadComboBoxSelectedIndexChangedEventArgs e)
		{
			...
			{
				if (e.Text == "Customer Actual" || e.Text == "Parent Customer Actual")
				{
			...
			if (e.CommandName == "RowClick")
	   		{
				...
				else if (filter == "Parent Customer Actual")
				{
					SalesForecastParentCustomerSelected.DataSource = PopulateSalesForecastParentCustomerSelected(filter, filterValue);
				...
				else if (filter == "Program Forecast" || filter == "Salesperson Actual")
				{
...
protected void SalesForecastSummariesRadGridDataSource_Selecting(object sender, SqlDataSourceSelectingEventArgs e)
	...
	private List<SalesForecast> PopulateSalesForecast(string filter)
	{
		...
		try
		{
			...
			{
	    		SqlCommand command = new SqlCommand("eeiuser.usp_WP_SalesForecastSummaries_MaterialPercentage2", connection);
				...
				using (SqlDataReader reader = command.ExecuteReader())
				{
	    			while (reader.Read())
					{
						...
						salesForecast.SalesActual_2016 = ReaderToDecimal(reader, "SalesActual_2016");
						salesForecast.ActualForecastVar_2016 = ReaderToDecimal(reader, "ActualForecastVar_2016");
						salesForecast.Sales_2017 = ReaderToDecimal(reader, "Sales_2017");
						salesForecast.SalesActual_2017 = ReaderToDecimal(reader, "SalesActual_2017");
						salesForecast.ActualForecastVar_2017 = ReaderToDecimal(reader, "ActualForecastVar_2017");
...
public class SalesForecast
{
	...
	public decimal? SalesActual_2016 { get; set; }
	public decimal? ActualForecastVar_2016 { get; set;}
	public decimal? Sales_2017 { get; set; }
	public decimal? SalesActual_2017 { get; set; }
	public decimal? ActualForecastVar_2017 { get; set;}
