            ...
            <HeaderTemplate>
                <asp:Table ID="Table1" runat="server" Height="40px" Width="100%">
                    <asp:TableRow runat="server" Height="20px">
                        ...
                        <asp:TableCell runat="server" Width="33%"> Requested by: <dx:ASPxLabel ID="Label1" runat="server" OnInit="Page_Load"></dx:ASPxLabel> on 
                            <dx:ASPxLabel ID="Label2" runat="server" OnInit="Page_Load"></dx:ASPxLabel>
                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" OnInit="Page_Load"></dx:ASPxLabel>
                    ...
                    <asp:TableRow runat="server" Height="20px" Width="100%">
                        <asp:TableCell runat="server"><dx:ASPxLabel ID="Label3" Font-Bold="true" Font-Size="Larger" runat="server"  OnInit="Page_Load"></dx:ASPxLabel>
...
<Caption ForeColor="#6666FF"></Caption>
    <Border BorderColor="#9999FF" BorderWidth="2px" />
        ...
        <asp:SqlDataSource ID="SqlDataSourcePFA" runat="server" ConnectionString="<%$ ConnectionStrings:MONITOR %>" SelectCommand="SELECT * FROM [eeiuser].[Freight_PFA] WHERE [PFA_ID] = (select max(PFA_ID) from eeiuser.freight_pfa)">
            </asp:SqlDataSource>           
