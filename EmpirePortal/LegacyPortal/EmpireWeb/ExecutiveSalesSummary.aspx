...
<div style="margin-bottom: 10px; padding: 10px">
	...
	<div id="divSalesForecastSelected" style="margin-top: 0px; margin-bottom: 25px" runat="server">
		...
		<telerik:RadGrid ID="SalesForecastSelected" runat="server" CellSpacing="1"
				...
				<telerik:GridBoundColumn DataField="ProductLine" FilterControlAltText="" HeaderText="Product Line" ReadOnly="True" SortExpression="ProductLine" UniqueName="ProductLine">
