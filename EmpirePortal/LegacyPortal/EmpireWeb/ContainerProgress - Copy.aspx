<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContainerProgress - Copy.aspx.cs" Inherits="ContainerProgress" %>
...
<br />
    ...
    <Telerik:RadGrid ID="RadGrid1" runat="server" Skin="Bootstrap"  Height="800px" Width="50%" AllowSorting ="True" 
                        DataSourceID="SDS_ContainerProgress" AutoGenerateColumns="False" ShowHeader="true" ShowFooter="True" FilterType="HeaderContext" >
    ...
    <GroupingSettings CollapseAllTooltip="Collapse all groups">
            ...
            <MasterTableView DataSourceID="SDS_ContainerProgress" DataKeyNames="part" IsFilterItemExpanded="false" EnableHeaderContextMenu="true" EnableHeaderContextFilterMenu="true" AllowFilteringByColumn="true" CommandItemDisplay="Top">
              <GroupByExpressions>
                  <Telerik:GridGroupByExpression>
                      <SelectFields>
                          ...
                          <Telerik:GridGroupByField FieldName="approved_qoh" HeaderText="Approved QOH" FormatString="{0:N0}" Aggregate="Sum" />
                ...
                <Columns>
                    <telerik:GridBoundColumn DataField="category"                                                                                                   HeaderStyle-Width="10%"  FilterControlAltText="Filter category column"       HeaderText="Category"           SortExpression="category"       UniqueName="category" GroupByExpression="category" DataType="System.String">
                    ...
                    <telerik:GridBoundColumn DataField="revision3"              UniqueName="revision3"                 HeaderText="Qty Required (Revision 3)"       HeaderStyle-Width="10%"     ItemStyle-HorizontalAlign="Right"    FooterStyle-HorizontalAlign="Right"     DataType="System.Int32"       FilterControlAltText="Filter revision3 column"                SortExpression="revision3"                  DataFormatString="{0:N0}"   Aggregate="Sum"     FooterAggregateFormatString="{0:N0}" >
                    </telerik:GridBoundColumn>                    
                    <telerik:GridBoundColumn DataField="approved_qoh"           UniqueName="approved_qoh"              HeaderText="Approved QOH"                    HeaderStyle-Width="8%"     ItemStyle-HorizontalAlign="Right"    FooterStyle-HorizontalAlign="Right"     DataType="System.Decimal"       FilterControlAltText="Filter approved_qoh column"           SortExpression="approved_qoh"               DataFormatString="{0:N0}"   Aggregate="Sum"     FooterAggregateFormatString="{0:N0}" >
                    </telerik:GridBoundColumn> 
                    ...
                    <telerik:GridBoundColumn DataField="unapproved_qoh"         UniqueName="unapproved_qoh"            HeaderText="Unapproved QOH"                  HeaderStyle-Width="8%"     ItemStyle-HorizontalAlign="Right"    FooterStyle-HorizontalAlign="Right"     DataType="System.Decimal"       FilterControlAltText="Filter unapproved_qoh column"         SortExpression="unapproved_qoh"             DataFormatString="{0:N0}"   Aggregate="Sum"     FooterAggregateFormatString="{0:N0}" >
                    </telerik:GridBoundColumn>
...
<%--                <Telerik:GridTemplateColumn UniqueName ="graph" DataField="qty_remaining_to_build" >
    ...
    <asp:Chart ID="Chart1" runat="server" DataSourceID="SDS_ContainerProgress" ImageStorageMode="UseImageLocation" ImageLocation="~/Images"  Height="12000px" Width="800px">
        <series>
            <asp:Series ChartType="StackedBar100" Name="Series1" XValueMember="part" YValueMembers="approved_qoh">
          </asp:Series>
