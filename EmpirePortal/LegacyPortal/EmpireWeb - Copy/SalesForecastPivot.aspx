<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesForecastPivot.aspx.cs" Inherits="SalesForecast" %>
        ...
        <div>
            ...
            <br />    
                        <telerik:RadPivotGrid ID="RadPivotGrid1" runat="server" DataSourceID="VehicleRadGridDataSource" AggregatesLevel="0" AllowNaturalSort="True" EnableCaching="True" EnableConfigurationPanel="True" EnableZoneContextMenu="False" RenderMode="Lightweight" RowGroupsDefaultExpanded="False"  ConfigurationPanelSettings-EnableDragDrop="False" ConfigurationPanelSettings-EnableOlapTreeViewLoadOnDemand="False" ColumnGroupsDefaultExpanded="False">
                            ...
                            <Fields>
                                <telerik:PivotGridRowField DataField="product_line" SortOrder="None" UniqueName="product_line">
                                </telerik:PivotGridRowField>
                                <telerik:PivotGridRowField DataField="vehicle" SortOrder="None" UniqueName="vehicle">
                                </telerik:PivotGridRowField>
                                ...
                                <telerik:PivotGridAggregateField CalculationExpression="Sum" DataField="Cal_17_Sales" DataFormatString="{0:C0}" GrandTotalAggregateFormatString="" IgnoreNullValues="True" SortOrder="None" TotalFormatString="{0:C0}" UniqueName="Cal_17_Sales">
                                    <TotalFormat Axis="Rows" Level="0" TotalFunction="NoCalculation" />
                                </telerik:PivotGridAggregateField>
