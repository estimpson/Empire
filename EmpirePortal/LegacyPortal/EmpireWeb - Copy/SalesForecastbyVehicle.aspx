<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SalesForecastbyVehicle.aspx.cs" Inherits="SalesForecast" %>
...
<body>
    ...
    <asp:Panel ID="Panel1" runat="server">
        <div>
            ...
            <br />    
                        <telerik:RadGrid ID="RadGrid1" runat="server" DataSourceID="VehicleRadGridDataSource" ShowGroupPanel="False" ShowFooter="true">
                <ExportSettings>
                ...
                <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top"  DataSourceID="VehicleRadGridDataSource" ShowGroupFooter="true">
            ...
            <asp:SqlDataSource  ID="VehicleRadGridDataSource" 
                                ...
                                sum(Total_2019_TotalDemand)  as Demand_2019, 
                                ...
                                where vehicle = @vehicle
	                             ...
	                             having (sum(Total_2015_Totaldemand)+sum(Total_2016_TotalDemand)+sum(Total_2017_TotalDemand)+sum(Total_2018_TotalDemand)+sum(Total_2019_TotalDemand)+sum(Cal20_TotalDemand)+sum(Cal21_TotalDemand))>0
                                 order by empire_market_segment, empire_market_subsegment, product_line, customer, base_part" >
           
                <SelectParameters>
                    <asp:ControlParameter   ControlID="VehicleComboBox" 
                                            Name="vehicle" 
