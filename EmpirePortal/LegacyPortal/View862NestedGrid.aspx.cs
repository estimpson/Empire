...
public partial class NALReview : System.Web.UI.Page
{
    ...
    protected void RadComboBox1_DataBound(object sender, EventArgs e)
    {
        ...
        RadGridM.MasterTableView.Columns[3].HeaderText = day0.Value.ToShortDateString();
        RadGridM.MasterTableView.Columns[4].HeaderText = day1.Value.ToShortDateString();
        RadGridM.MasterTableView.Columns[5].HeaderText = day2.Value.ToShortDateString();
        RadGridM.MasterTableView.Columns[6].HeaderText = day3.Value.ToShortDateString();
        RadGridM.MasterTableView.Columns[7].HeaderText = day4.Value.ToShortDateString();
    ...
    protected void  RadComboBox1_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
    {
        ...
        RadGridM.MasterTableView.Columns[3].HeaderText = day0.Value.ToString("ddd M/d/yyy");
        RadGridM.MasterTableView.Columns[4].HeaderText = day1.Value.ToShortDateString();
        RadGridM.MasterTableView.Columns[5].HeaderText = day2.Value.ToShortDateString();
        RadGridM.MasterTableView.Columns[6].HeaderText = day3.Value.ToShortDateString();
        RadGridM.MasterTableView.Columns[7].HeaderText = day4.Value.ToShortDateString();
