...
{
    public partial class SalesInitialsView : UserControl, IUserPanel
    {
        private readonly QuoteLogContext Context = new QuoteLogContext();

        public SalesInitialsView()
        {
            InitializeComponent();
        }
        ...
        public void ShowData()
        {
            ...
            try
            {
                ...
                gridControl1.DataSource = Context.SalesInitials.Local.ToBindingList();

                gridView1.Columns[0].Visible = false;
            }
            catch (Exception)
            {
                MessageBox.Show("Data could not be retrieved.", "Sales Initials");
            }
