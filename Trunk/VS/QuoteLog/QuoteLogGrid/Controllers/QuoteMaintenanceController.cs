...
{   
    public class QuoteMaintenanceController
    {
        ...
        {
            _theView.Requotes = _context.Requotes.Local.ToBindingList();
            _theView.Customers = _context.Customers.Local.ToBindingList();
            _theView.SalesInitials = _context.SalesInitials.Local.ToBindingList();
            _theView.ProgramManagerInitials = _context.ProgramManagerInitials.Local.ToBindingList();
            _theView.EngineeringInitials = _context.EngineeringInitials.Local.ToBindingList();
            _theView.EngineeringMaterialsInitials = _context.EngineeringMaterialsInitials.Local.ToBindingList();
            _theView.QuoteReviewInitials = _context.QuoteReviewInitials.Local.ToBindingList();
            _theView.QuotePricingInitials = _context.QuotePricingInitials.Local.ToBindingList();
            _theView.CustomerQuoteInitials = _context.CustomerQuoteInitials.Local.ToBindingList();
            _theView.Functions = _context.Functions.Local.ToBindingList();
            _theView.Applications = _context.Applications.Local.ToBindingList();
        }
        ...
        public int SavePrint(string printFilePath)
        {
            string errorMessage;
            _fileController.SavePrint(printFilePath, out errorMessage);
            if (errorMessage != "")
            {
