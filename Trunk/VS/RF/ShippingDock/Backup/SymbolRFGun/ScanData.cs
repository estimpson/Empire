...
namespace SymbolRFGun
{
    public class ScanData
    {
        ...
        private void BuildIdentifierDictionary()
        {
            ...
            ScanDataIdentifiers.Add("F", eScanDataType.Feeder);
            ScanDataIdentifiers.Add("SQ", eScanDataType.Squeegee);
            ScanDataIdentifiers.Add("ST", eScanDataType.Stencil);
            ScanDataIdentifiers.Add("SL", eScanDataType.Slot);
            ScanDataIdentifiers.Add("WO", eScanDataType.WorkOrder);
