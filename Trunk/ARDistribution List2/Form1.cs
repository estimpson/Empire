    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                                        ...
                                        try
                                        {
                                            ...
                                            if (test4)
                                            {
                                                mail.Body = "Invoice attached for your records. The following invoice was prepaid according to CIA terms:\r\n\r\n" + file +
                                                    "\r\n\r\nPlease address inquiries to:\r\n\r\nAccounts Receivable\r\naccountsreceivable@empireelect.com\r\n248-585-8130\r\n\r\nFax: 248-585-3686\r\n\r\nEmpire Electronics, Inc.\r\n214 East Maple Road\r\nTroy, MI 48098";
                                            ...
                                            SmtpClient theClient = new SmtpClient("10.90.10.102");
                                            theClient.UseDefaultCredentials = false;
                                            //System.Net.NetworkCredential theCredential = new System.Net.NetworkCredential("rlee", "nosoup4U!");
                                            System.Net.NetworkCredential theCredential = new System.Net.NetworkCredential("SVC_AR", ".!.iNd33pW@t3r.!.");
            ...
            try
            {
                ...
                mail2.To.Add("accountsreceivable@empireelect.com");
                ...
                SmtpClient theClient2 = new SmtpClient("10.90.10.102");
                ...
                System.Net.NetworkCredential theCredential2 = new System.Net.NetworkCredential("SVC_AR", ".!.iNd33pW@t3r.!.");
