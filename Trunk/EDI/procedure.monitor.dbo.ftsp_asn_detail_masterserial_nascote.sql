...
/****** Object:  StoredProcedure [dbo].[ftsp_asn_detail_masterserial_nascote]    Script Date: 04/09/2012 09:12:30 ******/
SET ANSI_NULLS ON
GO
...
if	objectproperty(object_id('dbo.ftsp_asn_detail_serial_nascote'), 'IsProcedure') = 1 begin
	drop procedure dbo.ftsp_asn_detail_masterserial_nascote
end
go
