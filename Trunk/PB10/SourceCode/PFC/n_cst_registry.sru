HA$PBExportHeader$n_cst_registry.sru
forward
...
constant string	DatabaseRoot = "HKEY_CURRENT_USER\Software\Fore-Thought\DatabaseProfiles\"
...
public subroutine of_getsqlserverprofilesettings (string as_appprofile, string as_profile, ref string as_servername, ref string as_database, ref string as_logid, ref string as_logpassword, ref unsignedlong alul_integratedsecurity, ref unsignedlong alul_autocommit)
