HA$PBExportHeader$w_invoice_detail.srw
$PBExportComments$Invoice detail screen
forward
global type w_invoice_detail from Window
end type
...
string	ls_csstatus
Dec{6}	dUnitPrice
Dec{6}	dQuantityShipped
Dec{6}	dFreightAmount
Dec{6}	dTaxRate
Dec{6}	dSalesTax
...
event activate;
ParentWindow ().ChangeMenu ( m_invoice_detail )
