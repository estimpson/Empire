HA$PBExportHeader$u_crosstab.sru
...
//	IF Int ( Mod ( 100 * l_l_row / i_l_rows, 10 ) ) = 1 THEN w_statusbar.wf_setstatus ( "Finishing up...", 101 * l_l_row / i_l_rows )
//NEXT
Return 0
end function
...
w_statusbar.cb_1.enabled = TRUE
i_l_row ++

l_s_part = object.part [ i_l_row ]
IF i_s_last_part <> l_s_part THEN
	IF i_l_rows > 0 THEN
		w_statusbar.wf_setstatus ( "Part: " + l_s_part, 101 * i_l_row / i_l_rows )
	END IF
END IF
...
event retrievestart;w_statusbar.wf_setstatus ( "Initializing...", 0 )
w_statusbar.cb_1.enabled = FALSE
