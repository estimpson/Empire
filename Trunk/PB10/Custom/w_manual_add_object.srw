HA$PBExportHeader$w_manual_add_object.srw
forward
...
IF IsValid ( w_main_screen ) THEN
	OpenSheetWithParm ( l_w_instance, l_str_parm, w_main_screen, 0, Layered! )
ELSEIF IsValid ( wmainscreen ) THEN
	OpenSheetWithParm ( l_w_instance, l_str_parm, wmainscreen, 0, Layered! )
ELSE
