HA$PBExportHeader$w_batch_release.srw
forward
...
CHOOSE CASE i_w_host
	...
	CASE w_smart_po_detail_entry_version3
		l_s_part 	= w_smart_po_detail_entry_version3.szpart  
		i_s_vendor 	= w_smart_po_detail_entry_version3.szvendor 
		i_l_po		= w_smart_po_detail_entry_version3.ipo
		dw_batch.setitem ( 1, 1,  l_s_part)
		dw_batch.setitem ( 1, 2,  f_get_part_info(l_s_part, "NAME") )
		dw_batch.settaborder ( 1, 0 )
		dw_batch.settaborder ( 2, 0 )
...
event itemchanged;/* 02-12-2004 MB  Modified to check non order status for part and add release accordingly */
String  l_s_part, &
		  l_s_vendor, &
		  l_s_nonorder_Status, &
		  l_s_note
...
if dwo.name = 'part' then
	...
	/* 02-12-2004 MB  Modified to check non order status for part */
	l_s_note = f_get_part_no_status ( data )
