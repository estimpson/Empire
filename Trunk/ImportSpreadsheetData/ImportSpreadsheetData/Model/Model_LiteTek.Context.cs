...
namespace ImportSpreadsheetData.Model
{
    ...
    public partial class MONITOREntities_LiteTek : DbContext
    {
        ...
        public virtual ObjectResult<string> usp_Process_ManualImport(string destination, ObjectParameter tranDT, ObjectParameter result, Nullable<int> testing, Nullable<int> debug)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("usp_Process_ManualImport", destinationParameter, tranDT, result, testingParameter, debugParameter);
        }
