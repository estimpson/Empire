...
/*
Create Procedure.MONITOR.TOPS.usp_PlanningSnapshot_CRUD_OverrideCustomerRequirement.sql
*/

use MONITOR
go

if	objectproperty(object_id('TOPS.usp_PlanningSnapshot_CRUD_OverrideCustomerRequirement'), 'IsProcedure') = 1 begin
	drop procedure TOPS.usp_PlanningSnapshot_CRUD_OverrideCustomerRequirement
end
go
