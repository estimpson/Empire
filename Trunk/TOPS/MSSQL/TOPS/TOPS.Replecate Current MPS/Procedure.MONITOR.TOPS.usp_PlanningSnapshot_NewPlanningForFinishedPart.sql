...
/*
Create Procedure.MONITOR.TOPS.usp_PlanningSnapshot_NewPlanningForFinishedPart.sql
*/

use MONITOR
go

if	objectproperty(object_id('TOPS.usp_PlanningSnapshot_NewPlanningForFinishedPart'), 'IsProcedure') = 1 begin
	drop procedure TOPS.usp_PlanningSnapshot_NewPlanningForFinishedPart
end
go
