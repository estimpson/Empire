...
/*
Create (EEH) Procedure.Monitor.TOPS.Leg_Get_EEH_Capacity.sql
*/

use Monitor
go

if	objectproperty(object_id('TOPS.Leg_Get_EEH_Capacity'), 'IsProcedure') = 1 begin
	drop procedure TOPS.Leg_Get_EEH_Capacity
end
go
