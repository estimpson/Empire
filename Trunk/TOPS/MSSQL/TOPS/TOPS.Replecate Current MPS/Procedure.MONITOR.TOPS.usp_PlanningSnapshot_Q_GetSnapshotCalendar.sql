...
/*
Create Procedure.MONITOR.TOPS.usp_PlanningSnapshot_Q_GetSnapshotCalendar.sql
*/

use MONITOR
go

if	objectproperty(object_id('TOPS.usp_PlanningSnapshot_Q_GetSnapshotCalendar'), 'IsProcedure') = 1 begin
	drop procedure TOPS.usp_PlanningSnapshot_Q_GetSnapshotCalendar
end
go
