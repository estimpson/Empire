...
/*
Create Procedure.MONITOR.TOPS.usp_PlanningSnapshot_Q_CurrentPartList.sql
*/

use MONITOR
go

if	objectproperty(object_id('TOPS.usp_PlanningSnapshot_Q_CurrentPartList'), 'IsProcedure') = 1 begin
	drop procedure TOPS.usp_PlanningSnapshot_Q_CurrentPartList
end
go
