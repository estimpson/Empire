...
/*
Create Table.MONITOR.TOPS.HolidaySchedule.sql
*/
...
drop table TOPS.HolidaySchedule

exec FT.sp_AddForeignKeys
*/
if	objectproperty(object_id('TOPS.HolidaySchedule'), 'IsTable') is null begin
...
/*
Create trigger TOPS.tr_HolidaySchedule_uRowModified on TOPS.HolidaySchedule
*/

--use MONITOR
--go

if	objectproperty(object_id('TOPS.tr_HolidaySchedule_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger TOPS.tr_HolidaySchedule_uRowModified
end
go
