...
/*
Create Procedure.MONITOR.TOPS.usp_PlanningSnapshot_GetCurrentPlanningCalendar.sql
*/

use MONITOR
go

if	objectproperty(object_id('TOPS.usp_PlanningSnapshot_GetCurrentPlanningCalendar'), 'IsProcedure') = 1 begin
	drop procedure TOPS.usp_PlanningSnapshot_GetCurrentPlanningCalendar
end
go
