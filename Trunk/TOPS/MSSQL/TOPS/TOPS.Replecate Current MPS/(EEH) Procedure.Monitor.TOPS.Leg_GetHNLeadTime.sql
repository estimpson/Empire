...
/*
Create (EEH) Procedure.Monitor.TOPS.Leg_GetHNLeadTime.sql
*/

use Monitor
go

if	objectproperty(object_id('TOPS.Leg_GetHNLeadTime'), 'IsProcedure') = 1 begin
	drop procedure TOPS.Leg_GetHNLeadTime
end
go
