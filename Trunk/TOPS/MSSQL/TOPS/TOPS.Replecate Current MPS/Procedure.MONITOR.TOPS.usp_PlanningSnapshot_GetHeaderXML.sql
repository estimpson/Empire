...
/*
Create Procedure.MONITOR.TOPS.usp_PlanningSnapshot_GetHeaderXML.sql
*/

use MONITOR
go

if	objectproperty(object_id('TOPS.usp_PlanningSnapshot_GetHeaderXML'), 'IsProcedure') = 1 begin
	drop procedure TOPS.usp_PlanningSnapshot_GetHeaderXML
end
go
