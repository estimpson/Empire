...
/*
Create Table.MONITOR.TOPS.HolidaySchedules.sql
*/
...
drop table TOPS.HolidaySchedules

exec FT.sp_AddForeignKeys
*/
if	objectproperty(object_id('TOPS.HolidaySchedules'), 'IsTable') is null begin
...
/*
Create trigger TOPS.tr_HolidaySchedules_uRowModified on TOPS.HolidaySchedules
*/

--use MONITOR
--go

if	objectproperty(object_id('TOPS.tr_HolidaySchedules_uRowModified'), 'IsTrigger') = 1 begin
	drop trigger TOPS.tr_HolidaySchedules_uRowModified
end
go
