...
/*
Create Table.FxSYS.FXSYS.ErrorLog.sql
*/
...
if	objectproperty(object_id('FXSYS.ErrorLog'), 'IsTable') is null begin
	...
	,	RowCreateDT datetime default(getdate()) null
	,	RowCreateUser sysname default(suser_name()) null
	,	RowModifiedDT datetime default(getdate()) null
	,	RowModifiedUser sysname default(suser_name()) null
	)
end
go
