/*	List manufacturing fluctuation from one production week to next for a Rev1 Schedule. */


/*
Create Procedure.MONITOR.TOPS.usp_Analysis_WeeklyManufacturingFluctuation.sql
*/

use MONITOR
go

if	objectproperty(object_id('TOPS.usp_Analysis_WeeklyManufacturingFluctuation'), 'IsProcedure') = 1 begin
	drop procedure TOPS.usp_Analysis_WeeklyManufacturingFluctuation
end
go
...
exec TOPS.usp_Analysis_WeeklyManufacturingFluctuation
	1000