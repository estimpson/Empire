...
SET ANSI_NULLS ON
GO
CREATE procedure [FS].[usp_QT_Files_DeleteFile]
...
begin
	...
	begin try
		...
		--- <Body>
		/*	Create file. */
		set @TocMsg = 'Delete file'
		begin
			declare
				@parentPathLocator hierarchyid

			select
				@parentPathLocator = FxUtilities.FS.udf_QT_Files_GetFilePathLocator(@ParentDirectoryPath)
			
			if	@parentPathLocator is null
			begin
				set	@Result = 999999
