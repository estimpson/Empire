...
SET ANSI_NULLS ON
GO
CREATE procedure [FS].[usp_QT_Files_OverwriteFile]
	@ParentDirectoryPath sysname
,	@FileName sysname
,	@FileContents varbinary(max)
,	@PathLocator hierarchyid = null out
...
execute
	@ProcReturn = dbo.usp_QT_Files_OverwriteFile
