...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3030.StagingShipScheduleHeaders'

	insert
		MONITOR.EDI3030.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3030.StagingShipScheduleSupplemental'
	
	insert 
		MONITOR.EDI3030.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3030.StagingShipScheduleAccums'

	insert  MONITOR.EDI3030.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3030.StagingShipScheduleAuthAccums'

	insert
		MONITOR.EDI3030.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3030.StagingShipSchedules'

	insert
		MONITOR.EDI3030.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3030.StagingPlanningHeaders'

	insert
		MONITOR.EDI3030.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		MONITOR.EDI3030.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3030.StagingPlanningAccums'

	insert
		MONITOR.EDI3030.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3030.StagingPlanningAuthAccums'

	insert
		MONITOR.EDI3030.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3030.StagingPlanningReleases'

	insert
		MONITOR.EDI3030.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	MONITOR.EDI3030.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	MONITOR.EDI3030.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	MONITOR.EDI3030.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	MONITOR.EDI3030.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	MONITOR.EDI3030.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	MONITOR.EDI3030.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	MONITOR.EDI3030.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	MONITOR.EDI3030.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	MONITOR.EDI3030.StagingPlanningSupplemental sfa
