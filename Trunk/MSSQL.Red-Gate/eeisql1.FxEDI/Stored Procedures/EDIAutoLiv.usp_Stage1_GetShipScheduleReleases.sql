...
CREATE procedure [EDIAutoLiv].[usp_Stage1_GetShipScheduleReleases]
...
if	@Debug > 0 begin
	...
	,	CustomerPO =	ed.Data.value('(	for $a in LOOP-LIN/SEG-REF/DE[@code="0128"] where $a="PO" return $a/../DE[. >> $a][@code="0127"][1])[1]', 'varchar(30)')
...
if	@Debug > 0 begin
	...
	,	UserDefined2 = ''
	,	UserDefined3 = ''
	,	UserDefined4 = Data.value('(	for $a in SEG-FST/DE[@code="0374"] where $a="ZZZ" return $a/../DE[. >> $a][@code="0337"][1])[1]', 'varchar(30)') --ShipWindow
	,	UserDefined5 =  Data.value('(	for $a in SEG-FST/DE[@code="0128"] where $a="DO" return $a/../DE[. >> $a][@code="0127"][1])[1]', 'varchar(30)') --RanNumber
...
(	RawDocumentGUID
	...
	,	UserDefined5 = Coalesce(nullif(UserDefined5,''), ReleaseNo,'')
	,	DateDue 
	,	QuantityDue 
	,	QuantityType
