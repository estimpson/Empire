...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2002.StagingShipScheduleHeaders'

	insert
		MONITOR.EDI2002.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2002.StagingShipScheduleSupplemental'
	
	insert 
		MONITOR.EDI2002.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2002.StagingShipScheduleAccums'

	insert  MONITOR.EDI2002.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2002.StagingShipScheduleAuthAccums'

	insert
		MONITOR.EDI2002.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2002.StagingShipSchedules'

	insert
		MONITOR.EDI2002.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2002.StagingPlanningHeaders'

	insert
		MONITOR.EDI2002.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		MONITOR.EDI2002.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2002.StagingPlanningAccums'

	insert
		MONITOR.EDI2002.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2002.StagingPlanningAuthAccums'

	insert
		MONITOR.EDI2002.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2002.StagingPlanningReleases'

	insert
		MONITOR.EDI2002.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	MONITOR.EDI2002.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	MONITOR.EDI2002.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	MONITOR.EDI2002.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	MONITOR.EDI2002.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	MONITOR.EDI2002.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	MONITOR.EDI2002.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	MONITOR.EDI2002.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	MONITOR.EDI2002.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	MONITOR.EDI2002.StagingPlanningSupplemental sfa
