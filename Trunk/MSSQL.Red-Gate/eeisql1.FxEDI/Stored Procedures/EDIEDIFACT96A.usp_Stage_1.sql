...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDIEDIFACT96A.StagingShipScheduleHeaders'

	insert
		MONITOR.EDIEDIFACT96A.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDIEDIFACT96A.StagingShipScheduleSupplemental'
	
	insert 
		MONITOR.EDIEDIFACT96A.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDIEDIFACT96A.StagingShipScheduleAccums'

	insert  MONITOR.EDIEDIFACT96A.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDIEDIFACT96A.StagingShipScheduleAuthAccums'

	insert
		MONITOR.EDIEDIFACT96A.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDIEDIFACT96A.StagingShipSchedules'

	insert
		MONITOR.EDIEDIFACT96A.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDIEDIFACT96A.StagingPlanningHeaders'

	insert
		MONITOR.EDIEDIFACT96A.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		MONITOR.EDIEDIFACT96A.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDIEDIFACT96A.StagingPlanningAccums'

	insert
		MONITOR.EDIEDIFACT96A.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDIEDIFACT96A.StagingPlanningAuthAccums'

	insert
		MONITOR.EDIEDIFACT96A.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDIEDIFACT96A.StagingPlanningReleases'

	insert
		MONITOR.EDIEDIFACT96A.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	MONITOR.EDIEDIFACT96A.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	MONITOR.EDIEDIFACT96A.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	MONITOR.EDIEDIFACT96A.StagingShipScheduleAccums sfs

Select 'StagingSSAuthAccums'
select 
	*
from
	MONITOR.EDIEDIFACT96A.StagingShipScheduleAuthAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	MONITOR.EDIEDIFACT96A.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	MONITOR.EDIEDIFACT96A.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	MONITOR.EDIEDIFACT96A.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	MONITOR.EDIEDIFACT96A.StagingPlanningAccums sfa

Select 'PlanningAuthAccums'	
select 
	*
from
	MONITOR.EDIEDIFACT96A.StagingPlanningAuthAccums sfa
Select 'PlanningSupplemental'	
select 
	*
from
	MONITOR.EDIEDIFACT96A.StagingPlanningSupplemental sfa
