...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2003.StagingShipScheduleHeaders'

	insert
		MONITOR.EDI2003.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2003.StagingShipScheduleSupplemental'
	
	insert 
		MONITOR.EDI2003.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2003.StagingShipScheduleAccums'

	insert  MONITOR.EDI2003.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2003.StagingShipScheduleAuthAccums'

	insert
		MONITOR.EDI2003.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2003.StagingShipSchedules'

	insert
		MONITOR.EDI2003.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2003.StagingPlanningHeaders'

	insert
		MONITOR.EDI2003.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		MONITOR.EDI2003.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2003.StagingPlanningAccums'

	insert
		MONITOR.EDI2003.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2003.StagingPlanningAuthAccums'

	insert
		MONITOR.EDI2003.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2003.StagingPlanningReleases'

	insert
		MONITOR.EDI2003.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	MONITOR.EDI2003.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	MONITOR.EDI2003.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	MONITOR.EDI2003.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	MONITOR.EDI2003.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	MONITOR.EDI2003.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	MONITOR.EDI2003.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	MONITOR.EDI2003.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	MONITOR.EDI2003.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	MONITOR.EDI2003.StagingPlanningSupplemental sfa
