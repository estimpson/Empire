...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2040.StagingShipScheduleHeaders'

	insert
		MONITOR.EDI2040.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2040.StagingShipScheduleSupplemental'
	
	insert 
		MONITOR.EDI2040.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2040.StagingShipScheduleAccums'

	insert  MONITOR.EDI2040.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2040.StagingShipScheduleAuthAccums'

	insert
		MONITOR.EDI2040.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2040.StagingShipSchedules'

	insert
		MONITOR.EDI2040.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2040.StagingPlanningHeaders'

	insert
		MONITOR.EDI2040.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		MONITOR.EDI2040.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2040.StagingPlanningAccums'

	insert
		MONITOR.EDI2040.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2040.StagingPlanningAuthAccums'

	insert
		MONITOR.EDI2040.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI2040.StagingPlanningReleases'

	insert
		MONITOR.EDI2040.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	MONITOR.EDI2040.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	MONITOR.EDI2040.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	MONITOR.EDI2040.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	MONITOR.EDI2040.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	MONITOR.EDI2040.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	MONITOR.EDI2040.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	MONITOR.EDI2040.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	MONITOR.EDI2040.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	MONITOR.EDI2040.StagingPlanningSupplemental sfa
