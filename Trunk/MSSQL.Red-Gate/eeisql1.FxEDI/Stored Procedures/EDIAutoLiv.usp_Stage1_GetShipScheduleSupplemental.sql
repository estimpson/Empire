...
CREATE procedure [EDIAutoLiv].[usp_Stage1_GetShipScheduleSupplemental]
...
insert
	...
	,	CustomerPO =	EdiData.Data.value('(	for $a in LOOP-LIN/SEG-REF/DE[@code="0128"] where $a="PO" return $a/../DE[. >> $a][@code="0127"][1])[1]', 'varchar(30)')
...
execute
	@ProcReturn = EDIAutoLiv.usp_Stage1_GetShipScheduleSupplimental
	@Param1 = @Param1
,	@TranDT = @TranDT out
