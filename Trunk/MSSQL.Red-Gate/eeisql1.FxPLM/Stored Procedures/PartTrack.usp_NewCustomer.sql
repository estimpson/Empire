...
create procedure [PartTrack].[usp_NewCustomer]
	@UserCode varchar(25)
,	@CustomerCode char(3)
,	@CustomerName varchar(100)
,	@MonitorCustomerCode varchar(50)
...
begin
	...
	,	InArguments =
			...
			+ ', @MonitorCustomerCode' + coalesce(@MonitorCustomerCode, '<null>')
...
execute
	@ProcReturn = PartTrack.usp_NewCustomer
