...
,	@HardToolingCAPEXID varchar(100)
	...
	begin try
		...
		--- </Body>
			...
			update
				aqtpo
			set
				aqtpo.HardToolingAmount = @HardToolingAmount
			,	aqtpo.HardToolingTrigger = @HardToolingTrigger
			,	aqtpo.HardToolingDescription = @HardToolingDescription
			,	aqtpo.HardToolingCAPEXID = @HardToolingCAPEXID
			from
				NSA.AwardedQuoteToolingPOs aqtpo
			where
				aqtpo.QuoteNumber = @QuoteNumber
