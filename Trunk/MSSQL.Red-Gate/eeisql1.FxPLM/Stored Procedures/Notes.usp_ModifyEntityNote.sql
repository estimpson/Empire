...
create procedure [Notes].[usp_ModifyEntityNote]
	@UserCode varchar(25)
	...
	begin try
		...
		begin
			...
			update
				n
			set
				n.SubjectLine = @SubjectLine
			,	n.Body = @Body
			--,	n.ThumbnailImage = @ThumbnailImage
			,	n.ReferencedURI = @ReferencedURI
			,	n.Category =
					(	select
							max(nc.RowID)
						from
			...
			,	n.ImportanceFlag = @ImportanceFlag
			,	n.PrivacyFlag = coalesce(@PrivacyFlag, n.PrivacyFlag)
			,	n.RowModifiedUser = @UserCode
			from
				Notes.Notes n
			where
				n.EntityGUID =
				...
				and
					(	n.Author =
						...
						or coalesce(@PrivacyFlag, n.PrivacyFlag) = 0
					)
				and n.RowID = @NoteID
...
execute
	@ProcReturn = Notes.usp_ModifyEntityNote
