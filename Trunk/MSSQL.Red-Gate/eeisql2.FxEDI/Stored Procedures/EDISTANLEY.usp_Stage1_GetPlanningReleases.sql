...
CREATE procedure [EDISTANLEY].[usp_Stage1_GetPlanningReleases]
...
,	UserDefined3 = ''
,	UserDefined4 = ''
,	UserDefined5 = COALESCE(Data.value('(for $a in SEG-FST/DE[@code="0373"] where $a="PO" return $a/../DE[. >> $a][@code="0374"][1])[1]', 'varchar(30)'), 'Forecast')
