...
CREATE procedure [EDIVARROCic].[usp_Stage1_GetPlanningReleases]
...
insert
	...
	,	UserDefined4 = ''
	,	UserDefined5 = ''
	,	DateDue = case when Data.value('(/SEG-FST/DE[@code="0681"])[1]', 'varchar(50)') = 'W' THEN Data.value('(/SEG-FST/DE[@code="0373"])[1]', 'varchar(50)') ELSE Data.value('(/SEG-FST/DE[@code="0373"])[2]', 'varchar(50)') END
