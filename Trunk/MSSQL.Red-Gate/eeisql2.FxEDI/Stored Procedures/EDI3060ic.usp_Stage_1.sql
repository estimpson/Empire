...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[MONITOR].EDI3060ic.StagingShipScheduleHeaders'

	insert
		[MONITOR].EDI3060ic.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleSupplemental')
	...
	--- <Insert rows="*">
	set	@TableName = '[MONITOR].EDI3060ic.StagingShipScheduleSupplemental'
	
	insert 
		[MONITOR].EDI3060ic.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[MONITOR].EDI3060ic.StagingShipScheduleAccums'

	insert  [MONITOR].EDI3060ic.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[MONITOR].EDI3060ic.StagingShipScheduleAuthAccums'

	insert
		[MONITOR].EDI3060ic.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipSchedules')
	...
	--- <Insert rows="*">
	set	@TableName = '[MONITOR].EDI3060ic.StagingShipSchedules'

	insert
		[MONITOR].EDI3060ic.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[MONITOR].EDI3060ic.StagingPlanningHeaders'

	insert
		[MONITOR].EDI3060ic.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
/*			- write Supplemental.*/
	...
	insert 
		[MONITOR].EDI3060ic.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[MONITOR].EDI3060ic.StagingPlanningAccums'

	insert
		[MONITOR].EDI3060ic.StagingPlanningAccums
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[MONITOR].EDI3060ic.StagingPlanningAuthAccums'

	insert
		[MONITOR].EDI3060ic.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningReleases')
	...
	--- <Insert rows="*">
	set	@TableName = '[MONITOR].EDI3060ic.StagingPlanningReleases'

	insert
		[MONITOR].EDI3060ic.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	[MONITOR].EDI3060ic.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	[MONITOR].EDI3060ic.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	[MONITOR].EDI3060ic.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	[MONITOR].EDI3060ic.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	[MONITOR].EDI3060ic.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	[MONITOR].EDI3060ic.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	[MONITOR].EDI3060ic.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	[MONITOR].EDI3060ic.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	[MONITOR].EDI3060ic.StagingPlanningSupplemental sfa
