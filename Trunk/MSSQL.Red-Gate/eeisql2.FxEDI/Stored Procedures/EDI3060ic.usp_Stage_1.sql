...
CREATE procedure [EDI3060ic].[usp_Stage_1]
...
/*	Move new and reprocessed 3060 862s and 830s to Staging. */
...
/*			- prepare Ship Schedules Supplemental.*/
	...
	-- <Call>	
	set	@CallProcName = 'EDI3060ic.usp_Stage1_GetShipScheduleSupplemental'
	execute
		@ProcReturn = EDI3060ic.usp_Stage1_GetShipScheduleSupplemental
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3060ic.usp_Stage1_GetShipScheduleSupplemental', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDI3060ic.usp_Stage1_GetShipScheduleAccums'
	execute
		@ProcReturn = EDI3060ic.usp_Stage1_GetShipScheduleAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3060ic.usp_Stage1_GetShipScheduleAccums', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDI3060ic.usp_Stage1_GetShipScheduleAuthAccums'
	execute
		@ProcReturn = EDI3060ic.usp_Stage1_GetShipScheduleAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3060ic.usp_Stage1_GetShipScheduleAuthAccums', @toc
...
create table
	...
	-- <Call>	
	set	@CallProcName = 'EDI3060ic.usp_Stage1_GetShipScheduleReleases'
	execute
		@ProcReturn = EDI3060ic.usp_Stage1_GetShipScheduleReleases
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3060ic.usp_Stage1_GetShipScheduleReleases', @toc
...
/*			- prepare Release Plans Supplemental.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI3060ic.usp_Stage1_GetPlanningsupplemental'
	execute
		@ProcReturn = EDI3060ic.usp_Stage1_GetPlanningsupplemental
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3060ic.usp_Stage1_GetPlanningsupplemental', @toc
...
/*			- prepare Release Plans Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI3060ic.usp_Stage1_GetPlanningAccums'
	execute
		@ProcReturn = EDI3060ic.usp_Stage1_GetPlanningAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3060ic.usp_Stage1_GetPlanningAccums', @toc
...
/* -Prepare Planning Auth Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI3060ic.usp_Stage1_GetPlanningAuthAccums'
	execute
		@ProcReturn = EDI3060ic.usp_Stage1_GetPlanningAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3060ic.usp_Stage1_GetPlanningAuthAccumss', @toc
...
/*			- prepare Release Plan Releases.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI3060ic.usp_Stage1_GetPlanningReleases'
	execute
		@ProcReturn = EDI3060ic.usp_Stage1_GetPlanningReleases
			@Result = @ProcResult out
		,	@Debug = @Debug
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleHeaders'

	insert
		[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleSupplemental')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleSupplemental'
	
	insert 
		[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleAccums'

	insert  [EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleAuthAccums'

	insert
		[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipSchedules')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3060ic.StagingShipSchedules'

	insert
		[EEISQL1].[MONITOR].EDI3060ic.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningHeaders'

	insert
		[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
/*			- write Supplemental.*/
	...
	insert 
		[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningAccums'

	insert
		[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningAccums
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningAuthAccums'

	insert
		[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningReleases')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningReleases'

	insert
		[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
set @Result = 100
raiserror ('3060 documents already in process.  Use EDI3060ic.usp_ClearQueue to clear the queue if necessary.', 16, 1)
return
--- </Error>
...
execute
	@ProcReturn = EDI3060ic.usp_Stage_1
	@TranDT = @TranDT out
,	@Result = @ProcResult out
...
select
	*
from
	[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	[EEISQL1].[MONITOR].EDI3060ic.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	[EEISQL1].[MONITOR].EDI3060ic.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	[EEISQL1].[MONITOR].EDI3060ic.StagingPlanningSupplemental sfa
