...
CREATE procedure [EDISTANLEY].[usp_Stage_1]
...
/*			- prepare Ship Schedules Supplemental.*/
	...
	-- <Call>	
	set	@CallProcName = 'EDISTANLEY.usp_Stage1_GetShipScheduleSupplemental'
	execute
		@ProcReturn = EDISTANLEY.usp_Stage1_GetShipScheduleSupplemental
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDISTANLEY.usp_Stage1_GetShipScheduleSupplemental', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDISTANLEY.usp_Stage1_GetShipScheduleAccums'
	execute
		@ProcReturn = EDISTANLEY.usp_Stage1_GetShipScheduleAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDISTANLEY.usp_Stage1_GetShipScheduleAccums', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDISTANLEY.usp_Stage1_GetShipScheduleAuthAccums'
	execute
		@ProcReturn = EDISTANLEY.usp_Stage1_GetShipScheduleAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDISTANLEY.usp_Stage1_GetShipScheduleAuthAccums', @toc
...
create table
	...
	-- <Call>	
	set	@CallProcName = 'EDISTANLEY.usp_Stage1_GetShipScheduleReleases'
	execute
		@ProcReturn = EDISTANLEY.usp_Stage1_GetShipScheduleReleases
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDISTANLEY.usp_Stage1_GetShipScheduleReleases', @toc
...
/*			- prepare Release Plans Supplemental.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDISTANLEY.usp_Stage1_GetPlanningsupplemental'
	execute
		@ProcReturn = EDISTANLEY.usp_Stage1_GetPlanningsupplemental
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDISTANLEY.usp_Stage1_GetPlanningsupplemental', @toc
...
/*			- prepare Release Plans Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDISTANLEY.usp_Stage1_GetPlanningAccums'
	execute
		@ProcReturn = EDISTANLEY.usp_Stage1_GetPlanningAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDISTANLEY.usp_Stage1_GetPlanningAccums', @toc
...
/* -Prepare Planning Auth Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDISTANLEY.usp_Stage1_GetPlanningAuthAccums'
	execute
		@ProcReturn = EDISTANLEY.usp_Stage1_GetPlanningAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDISTANLEY.usp_Stage1_GetPlanningAuthAccumss', @toc
...
/*			- prepare Release Plan Releases.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDISTANLEY.usp_Stage1_GetPlanningReleases'
	execute
		@ProcReturn = EDISTANLEY.usp_Stage1_GetPlanningReleases
			@Result = @ProcResult out
		,	@Debug = @Debug
...
set @Result = 100
raiserror ('4010 documents already in process.  Use EDISTANLEY.usp_ClearQueue to clear the queue if necessary.', 16, 1)
return
--- </Error>
...
execute
	@ProcReturn = EDISTANLEY.usp_Stage_1
	@TranDT = @TranDT out
,	@Result = @ProcResult out
