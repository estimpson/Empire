...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3020.StagingShipScheduleHeaders'

	insert
		MONITOR.EDI3020.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3020.StagingShipScheduleSupplemental'
	
	insert 
		MONITOR.EDI3020.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3020.StagingShipScheduleAccums'

	insert  MONITOR.EDI3020.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3020.StagingShipScheduleAuthAccums'

	insert
		MONITOR.EDI3020.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3020.StagingShipSchedules'

	insert
		MONITOR.EDI3020.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3020.StagingPlanningHeaders'

	insert
		MONITOR.EDI3020.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if	exists
	...
	insert 
		MONITOR.EDI3020.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3020.StagingPlanningAccums'

	insert
		MONITOR.EDI3020.StagingPlanningAccums
	 (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3020.StagingPlanningAuthAccums'

	insert
		MONITOR.EDI3020.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if	exists
	...
	--- <Insert rows="*">
	set	@TableName = 'MONITOR.EDI3020.StagingPlanningReleases'

	INSERT
		MONITOR.EDI3020.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
select
	*
from
	MONITOR.EDI3020.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	MONITOR.EDI3020.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	MONITOR.EDI3020.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	MONITOR.EDI3020.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	MONITOR.EDI3020.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	MONITOR.EDI3020.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	MONITOR.EDI3020.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	MONITOR.EDI3020.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	MONITOR.EDI3020.StagingPlanningSupplemental sfa
