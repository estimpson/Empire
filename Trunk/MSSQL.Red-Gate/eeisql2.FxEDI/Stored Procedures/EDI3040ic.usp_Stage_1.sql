...
CREATE procedure [EDI3040ic].[usp_Stage_1]
...
/*	Move new and reprocessed 3040 862s and 830s to Staging. */
...
/*			- prepare Ship Schedules Supplemental.*/
	...
	-- <Call>	
	set	@CallProcName = 'EDI3040ic.usp_Stage1_GetShipScheduleSupplemental'
	execute
		@ProcReturn = EDI3040ic.usp_Stage1_GetShipScheduleSupplemental
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3040ic.usp_Stage1_GetShipScheduleSupplemental', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDI3040ic.usp_Stage1_GetShipScheduleAccums'
	execute
		@ProcReturn = EDI3040ic.usp_Stage1_GetShipScheduleAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3040ic.usp_Stage1_GetShipScheduleAccums', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDI3040ic.usp_Stage1_GetShipScheduleAuthAccums'
	execute
		@ProcReturn = EDI3040ic.usp_Stage1_GetShipScheduleAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3040ic.usp_Stage1_GetShipScheduleAuthAccums', @toc
...
create table
	...
	-- <Call>	
	set	@CallProcName = 'EDI3040ic.usp_Stage1_GetShipScheduleReleases'
	execute
		@ProcReturn = EDI3040ic.usp_Stage1_GetShipScheduleReleases
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3040ic.usp_Stage1_GetShipScheduleReleases', @toc
...
/*			- prepare Release Plans Supplemental.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI3040ic.usp_Stage1_GetPlanningsupplemental'
	execute
		@ProcReturn = EDI3040ic.usp_Stage1_GetPlanningsupplemental
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3040ic.usp_Stage1_GetPlanningsupplemental', @toc
...
/*			- prepare Release Plans Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI3040ic.usp_Stage1_GetPlanningAccums'
	execute
		@ProcReturn = EDI3040ic.usp_Stage1_GetPlanningAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3040ic.usp_Stage1_GetPlanningAccums', @toc
...
/* -Prepare Planning Auth Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI3040ic.usp_Stage1_GetPlanningAuthAccums'
	execute
		@ProcReturn = EDI3040ic.usp_Stage1_GetPlanningAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI3040ic.usp_Stage1_GetPlanningAuthAccumss', @toc
...
/*			- prepare Release Plan Releases.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI3040ic.usp_Stage1_GetPlanningReleases'
	execute
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleHeaders'

	insert
		[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleSupplemental')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleSupplemental'
	
	insert 
		[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleAccums'

	insert  [EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleAuthAccums'

	insert
		[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipSchedules')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3040ic.StagingShipSchedules'

	insert
		[EEISQL1].[MONITOR].EDI3040ic.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningHeaders'

	insert
		[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
/*			- write Supplemental.*/
	...
	insert 
		[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningAccums'

	insert
		[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningAccums
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningAuthAccums'

	insert
		[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningReleases')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningReleases'

	insert
		[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
IF	EXISTS
	...
	--- <Update rows="*">
	SET	@TableName = 'EDI3040ic.ShipScheduleHeaders'
...
set @Result = 100
raiserror ('3040 documents already in process.  Use EDI3040ic.usp_ClearQueue to clear the queue if necessary.', 16, 1)
return
--- </Error>
...
execute
	@ProcReturn = EDI3040ic.usp_Stage_1
	@TranDT = @TranDT out
,	@Result = @ProcResult out
...
select
	*
from
	[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	[EEISQL1].[MONITOR].EDI3040ic.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	[EEISQL1].[MONITOR].EDI3040ic.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	[EEISQL1].[MONITOR].EDI3040ic.StagingPlanningSupplemental sfa
