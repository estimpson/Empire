...
CREATE procedure [EDIMagnaITC].[usp_Stage_1]
...
/*			- prepare Ship Schedules Supplemental.*/
	...
	-- <Call>	
	set	@CallProcName = 'EDIMagnaITC.usp_Stage1_GetShipScheduleSupplemental'
	execute
		@ProcReturn = EDIMagnaITC.usp_Stage1_GetShipScheduleSupplemental
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDIMagnaITC.usp_Stage1_GetShipScheduleSupplemental', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDIMagnaITC.usp_Stage1_GetShipScheduleAccums'
	execute
		@ProcReturn = EDIMagnaITC.usp_Stage1_GetShipScheduleAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDIMagnaITC.usp_Stage1_GetShipScheduleAccums', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDIMagnaITC.usp_Stage1_GetShipScheduleAuthAccums'
	execute
		@ProcReturn = EDIMagnaITC.usp_Stage1_GetShipScheduleAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDIMagnaITC.usp_Stage1_GetShipScheduleAuthAccums', @toc
...
create table
	...
	-- <Call>	
	set	@CallProcName = 'EDIMagnaITC.usp_Stage1_GetShipScheduleReleases'
	execute
		@ProcReturn = EDIMagnaITC.usp_Stage1_GetShipScheduleReleases
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDIMagnaITC.usp_Stage1_GetShipScheduleReleases', @toc
...
/*			- prepare Release Plans Supplemental.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDIMagnaITC.usp_Stage1_GetPlanningsupplemental'
	execute
		@ProcReturn = EDIMagnaITC.usp_Stage1_GetPlanningsupplemental
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDIMagnaITC.usp_Stage1_GetPlanningsupplemental', @toc
...
/*			- prepare Release Plans Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDIMagnaITC.usp_Stage1_GetPlanningAccums'
	execute
		@ProcReturn = EDIMagnaITC.usp_Stage1_GetPlanningAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDIMagnaITC.usp_Stage1_GetPlanningAccums', @toc
...
/* -Prepare Planning Auth Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDIMagnaITC.usp_Stage1_GetPlanningAuthAccums'
	execute
		@ProcReturn = EDIMagnaITC.usp_Stage1_GetPlanningAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDIMagnaITC.usp_Stage1_GetPlanningAuthAccumss', @toc
...
/*			- prepare Release Plan Releases.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDIMagnaITC.usp_Stage1_GetPlanningReleases'
	execute
		@ProcReturn = EDIMagnaITC.usp_Stage1_GetPlanningReleases
			@Result = @ProcResult out
		,	@Debug = @Debug
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleHeaders'

	insert
		[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleSupplemental')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleSupplemental'
	
	insert 
		[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleAccums'

	insert  [EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleAuthAccums'

	insert
		[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipSchedules')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipSchedules'

	insert
		[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningHeaders'

	insert
		[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
/*			- write Supplemental.*/
	...
	insert 
		[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningAccums'

	insert
		[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningAccums
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningAuthAccums'

	insert
		[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningReleases')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningReleases'

	insert
		[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
set @Result = 100
raiserror ('4010 documents already in process.  Use EDIMagnaITC.usp_ClearQueue to clear the queue if necessary.', 16, 1)
return
--- </Error>
...
execute
	@ProcReturn = EDIMagnaITC.usp_Stage_1
	@TranDT = @TranDT out
,	@Result = @ProcResult out
...
select
	*
from
	[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	[EEISQL1].[MONITOR].EDIMagnaITC.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	[EEISQL1].[MONITOR].EDIMagnaITC.StagingPlanningSupplemental sfa
