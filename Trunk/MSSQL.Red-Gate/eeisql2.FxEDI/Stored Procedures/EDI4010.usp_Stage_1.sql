...
/*			- prepare Ship Schedules Supplemental.*/
	...
	-- <Call>	
	set	@CallProcName = 'EDI4010.usp_Stage1_GetShipScheduleSupplemental'
	execute
		@ProcReturn = EDI4010.usp_Stage1_GetShipScheduleSupplemental
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI4010.usp_Stage1_GetShipScheduleSupplemental', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDI4010.usp_Stage1_GetShipScheduleAccums'
	execute
		@ProcReturn = EDI4010.usp_Stage1_GetShipScheduleAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI4010.usp_Stage1_GetShipScheduleAccums', @toc
...
Create table
	...
	-- <Call>	
	set	@CallProcName = 'EDI4010.usp_Stage1_GetShipScheduleAuthAccums'
	execute
		@ProcReturn = EDI4010.usp_Stage1_GetShipScheduleAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI4010.usp_Stage1_GetShipScheduleAuthAccums', @toc
...
create table
	...
	-- <Call>	
	set	@CallProcName = 'EDI4010.usp_Stage1_GetShipScheduleReleases'
	execute
		@ProcReturn = EDI4010.usp_Stage1_GetShipScheduleReleases
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI4010.usp_Stage1_GetShipScheduleReleases', @toc
...
/*			- prepare Release Plans Supplemental.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI4010.usp_Stage1_GetPlanningsupplemental'
	execute
		@ProcReturn = EDI4010.usp_Stage1_GetPlanningsupplemental
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI4010.usp_Stage1_GetPlanningsupplemental', @toc
...
/*			- prepare Release Plans Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI4010.usp_Stage1_GetPlanningAccums'
	execute
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI4010.usp_Stage1_GetPlanningAccums', @toc
...
/* -Prepare Planning Auth Accums.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI4010.usp_Stage1_GetPlanningAuthAccums'
	execute
		@ProcReturn = EDI4010.usp_Stage1_GetPlanningAuthAccums
			@Result = @ProcResult out
		,	@Debug = @Debug
	...
	if	@Debug > 0 begin
		set	@toc = getdate() - @TranDT
		select 'EDI4010.usp_Stage1_GetPlanningAuthAccumss', @toc
...
/*			- prepare Release Plan Releases.*/
	...
	--- <Call>	
	set	@CallProcName = 'EDI4010.usp_Stage1_GetPlanningReleases'
	execute
		@ProcReturn = EDI4010.usp_Stage1_GetPlanningReleases
			@Result = @ProcResult out
		,	@Debug = @Debug
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleHeaders'

	insert
		[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleSupplemental')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleSupplemental'
	
	insert 
		[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleAccums'

	insert  [EEISQL1].[MONITOR].EDI4010.StagingShipScheduleAccums
    (	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipScheduleAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleAuthAccums'

	insert
		[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#ShipSchedules')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI4010.StagingShipSchedules'

	insert
		[EEISQL1].[MONITOR].EDI4010.StagingShipSchedules
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningHeaders')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI4010.StagingPlanningHeaders'

	insert
		[EEISQL1].[MONITOR].EDI4010.StagingPlanningHeaders
	(	RawDocumentGUID
	,	DocumentImportDT
	,	TradingPartner
	,	DocType
...
/*			- write Supplemental.*/
	...
	insert 
		[EEISQL1].[MONITOR].EDI4010.StagingPlanningSupplemental
	(	RawDocumentGUID
    ,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI4010.StagingPlanningAccums'

	insert
		[EEISQL1].[MONITOR].EDI4010.StagingPlanningAccums
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningAuthAccums')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI4010.StagingPlanningAuthAccums'

	insert
		[EEISQL1].[MONITOR].EDI4010.StagingPlanningAuthAccums
	(	
		RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
...
if exists (
   ...
   and o.id = object_id(N'tempdb..#PlanningReleases')
	...
	--- <Insert rows="*">
	set	@TableName = '[EEISQL1].[MONITOR].EDI4010.StagingPlanningReleases'

	insert
		[EEISQL1].[MONITOR].EDI4010.StagingPlanningReleases
	(	RawDocumentGUID
	,	ReleaseNo
	,	ShipToCode
	,	ConsigneeCode
...
set @Result = 100
raiserror ('4010 documents already in process.  Use EDI4010.usp_ClearQueue to clear the queue if necessary.', 16, 1)
return
--- </Error>
...
select
	*
from
	[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleHeaders sfh

Select 'StagingSSchedules'
select
	*
from
	[EEISQL1].[MONITOR].EDI4010.StagingShipSchedules sfr

Select 'StagingSSAccums'
select 
	*
from
	[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleAccums sfs

Select 'StagingSSSupplemental'
select 
	*
from
	[EEISQL1].[MONITOR].EDI4010.StagingShipScheduleSupplemental sfs
go
...
select
	*
from
	[EEISQL1].[MONITOR].EDI4010.StagingPlanningHeaders sfh

Select 'PlanningReleases'
select
	*
from
	[EEISQL1].[MONITOR].EDI4010.StagingPlanningReleases sfr

Select 'PlanningAccums'	
select 
	*
from
	[EEISQL1].[MONITOR].EDI4010.StagingPlanningAccums sfa
Select 'PlanningAuthAccums'	

select 
	*
from
	[EEISQL1].[MONITOR].EDI4010.StagingPlanningAuthAccums sfa

Select 'PlanningSupplemental'	
select 
	*
from
	[EEISQL1].[MONITOR].EDI4010.StagingPlanningSupplemental sfa
