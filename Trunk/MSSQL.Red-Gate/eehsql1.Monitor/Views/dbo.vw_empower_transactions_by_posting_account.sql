...
--SELECT SUM(amount) FROM [dbo].[vw_empower_transactions_by_posting_account] WHERE posting_account = '151012' AND fiscal_year = '2018' AND period = 2
...
FROM
	EEH_Empower..monitor_inventory_transactions 
	INNER JOIN EEH_Empower..monitor_inventory_transaction_allocations ON
		monitor_inventory_transactions.monitor_inventory_transaction_id = monitor_inventory_transaction_allocations.monitor_inventory_transaction_id 
	INNER JOIN EEH_Empower..monitor_inventory_documents ON
