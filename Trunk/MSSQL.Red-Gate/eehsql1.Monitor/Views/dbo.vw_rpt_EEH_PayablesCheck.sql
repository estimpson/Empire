...
FROM	 EEH_Empower.dbo.vr_ap_check_proof vr_ap_check_proof 
left join	 EEH_Empower.dbo.document_approval_items document_approval_items on document_approval_items.document_id1 = vr_ap_check_proof.document_id1 
...
left join (	select vendor,comments,note_date
			from   EEH_Empower.dbo.vendor_notes
