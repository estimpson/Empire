...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [HN].[HCSP_WIPWASH_Report]( @From datetime, @To datetime )
AS
...
INSERT #Reporte( Part, MI_RM, MA_RM )
SELECT	Part,
...
INSERT #Reporte( Part, MI_FG,MA_FG,DE_FG,JC_FG )
...
INSERT #Reporte( Part, MI_WIP,MA_WIP,DE_WIP,JC_WIP )
SELECT	Part = childpart,
