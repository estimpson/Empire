...
CREATE procedure [estimpson].[uspTestATPostingWithGLComparePCB]
as
declare
	@Period varchar(1000) = 'Custom'
,	@Year int = null
,	@Month int = null
,	@FromDT datetime = '2013-07-21'
,	@ToDT datetime = '2013-07-21'
,	@Transactions varchar(25) = null
,	@Accounts varchar(1000) = '152508'
...
,	ToDT
from
	dbo.udf_GetPeriodBounds ('Custom', null, null, '2013-07-21', '2013-07-21') PeriodBounds
