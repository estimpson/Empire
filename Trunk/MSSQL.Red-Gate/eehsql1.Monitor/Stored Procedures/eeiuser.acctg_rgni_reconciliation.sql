...
/*
Eg.
exec eeiuser.acctg_rgni_reconciliation  212012, '2014-04-30', '2014-05-31'
*/
set transaction isolation level read uncommitted;

delete eeh.eeiuser.acctg_rgni_selected_gl_transactions
delete eeh.eeiuser.acctg_rgni_comparison
...
and document_type <> 'Ap Check'
and document_type <> 'AP Check Void'

insert into eeh.eeiuser.acctg_rgni_selected_gl_transactions
...
and (a.purchase_order = CONVERT(varchar(25),po_headers.purchase_order))
and (a.item = part.part)
and   (   (@account_code = '212012' and part.product_line != 'PCB')
       or
       (@account_code = '212008' and part.product_line = 'PCB')
   )
...
insert into eeh.eeiuser.acctg_rgni_comparison
...
select  distinct(id),
		...
		0,
		0
from	eeh.eeiuser.acctg_rgni_selected_gl_transactions c
