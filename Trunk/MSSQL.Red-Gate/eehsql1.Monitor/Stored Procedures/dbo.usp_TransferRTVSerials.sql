...
create procedure [dbo].[usp_TransferRTVSerials]
...
declare	
	@Notes varchar(255)
select		
	@Notes = 'Transfer of serials for RTV shipper: ' + convert(varchar(25), @RtvShipper) + '.'
...
from 
	dbo.audit_trail at2
where
	at2.shipper = convert(varchar(25), @RtvShipper)
	and at2.type = 'V'
