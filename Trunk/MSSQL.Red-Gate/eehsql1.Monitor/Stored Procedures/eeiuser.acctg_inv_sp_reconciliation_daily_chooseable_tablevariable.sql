...
-- exec eeiuser.acctg_inv_sp_reconciliation_daily_chooseable '2016-01-03','2016-01-04','153012','WIRE HARN-EEH','F','HONDURAS'


CREATE procedure [eeiuser].[acctg_inv_sp_reconciliation_daily_chooseable_tablevariable]
	@begdate datetime
,	@enddate datetime
,	@account varchar(10)
