...
where ah.vendor = 'FEDEX' and ah.gl_date >= @start_date and ah.gl_date < @end_date
...
WHERE	gl_cost_transactions.ledger_account in ('504512', '505512','504508','504512')
		AND gl_cost_transactions.document_id2 not in ('FEDEX')
...
documentremarks like '%*%' and Vendor not in ('FEDEX')
...
select  '----' as Spacer1,
              ...
              [Saturday Pickup],  
              [PackageNetCharge]  
from eeisql1.fedexfft.dbo.fbodataflatcharges) b
