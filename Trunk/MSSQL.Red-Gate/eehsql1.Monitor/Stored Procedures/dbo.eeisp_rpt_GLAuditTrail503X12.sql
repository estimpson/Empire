...
CREATE Procedure [dbo].[eeisp_rpt_GLAuditTrail503X12] (@FiscalYear int, @Period int)
as
Begin

--exec eeisp_rpt_GLAuditTrail503X12 2013,6 
...
(	ID int,
	...
	Type	char(1),
	StdQty	numeric(20,6),
	primary key (Serial, DateStamp, ID))
...
where	fiscal_year =@FiscalYear and 
		...
		ledger_account in  ('503012', '503512')
...
left	join	#AuditTrail AT on GLCT.serial = AT.Serial and GLCT.DateStamp = AT.DateStamp and GLCT.Type = AT.Type
End
