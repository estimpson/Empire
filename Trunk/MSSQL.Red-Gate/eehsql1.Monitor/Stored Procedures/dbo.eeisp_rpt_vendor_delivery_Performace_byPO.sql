...
SET ANSI_NULLS ON
GO
Create procedure	[dbo].[eeisp_rpt_vendor_delivery_Performace_byPO] (@startdate datetime, @PONumber int)
...
from		#Auths  Authorizations
			...
			WHERE  po_header.type = 'B' and   Authorizations.AuthorizedAccum > 0 and Authorizations.PONumber = @PONumber and
