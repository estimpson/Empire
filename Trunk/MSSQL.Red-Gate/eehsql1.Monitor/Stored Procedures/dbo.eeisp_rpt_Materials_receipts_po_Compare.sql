...
CREATE	procedure [dbo].[eeisp_rpt_Materials_receipts_po_Compare] (@Date datetime, @DayofWeek int, @PriorWeekSchedule int)
as
begin

--eeisp_rpt_Materials_receipts_po_Compare '2008-12-02', 2, 1
...
Receipts.EOW,
		...
		Receipts.Cost,
		Receipts.Vendor_code,
		Receipts.standard_pack) Receipts left Join
...
from		#POReceiptsEval
--left join	#DetailReceipts on #POReceiptsEval.Part = ATpart and ATPO = ATShipperPO
--left join	#POReceivers on #POReceiptsEval.ATPO = #POReceivers.Purchase_order and Part  = Item and ATShipper=PRI_Shipper
