...
[Box48_FTZTitle] [varchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Box49_FTZDate] [varchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
ALTER TABLE [eeiuser].[FTZ_Form214Header] ADD CONSTRAINT [PK_FTZ_Form214Header] PRIMARY KEY CLUSTERED  ([Box6_ZoneAdmissionNo]) ON [PRIMARY]
GO
