...
create procedure [EEIUser].[acctg_csm_sp_rollforward_base_part_mnemonic]
...
insert into 
	eeiuser.acctg_csm_base_part_mnemonic
(	
	RELEASE_ID
,	FORECAST_ID
,	MNEMONIC
...
,	m.FAMILY_ALLOCATION
from	
	EEIUser.acctg_csm_base_part_mnemonic m
where	
	m.release_id = @PriorRelease
