...
CREATE procedure [EEIUser].[usp_ST_SalesLeadLog_Update]
...
--- <Update rows="1">
set	@TableName = 'EEIUser.EEIUser.vw_ST_LightingStudy_2016'

update
	ls
set
	ls.[Status] = @Status
,	ls.AwardedVolume = @AwardedVolume
from
	EEIUser.ST_LightingStudy_2016 ls
where
	ls.ID = @CombinedLightingId
