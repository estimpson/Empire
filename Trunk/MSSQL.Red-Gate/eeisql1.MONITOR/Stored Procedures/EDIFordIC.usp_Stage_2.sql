...
Create procedure [EDIFordIC].[usp_Stage_2]
...
execute
	...
	@objname = N'EDIFordIC.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDIFordIC.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIFordIC.ShipScheduleSupplemental'

insert
	EDIFordIC.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFordIC.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIFordIC.ShipScheduleAccums'

insert
	EDIFordIC.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFordIC.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFordIC.ShipScheduleAuthAccums'

insert
	EDIFordIC.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFordIC.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFordIC.ShipSchedules'

insert
	EDIFordIC.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIFordIC.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDIFordIC.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIFordIC.PlanningSupplemental'

insert
	EDIFordIC.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFordIC.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIFordIC.PlanningAccums'

insert
	EDIFordIC.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFordIC.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFordIC.PlanningAuthAccums'

insert
	EDIFordIC.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFordIC.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDIFordIC.StagingPlanningReleasesT sfr
...
truncate table
	EDIFordIC.StagingShipScheduleHeadersT
truncate table
	EDIFordIC.StagingShipScheduleSupplementalT
truncate table
	EDIFordIC.StagingShipScheduleAccumsT
truncate table
	EDIFordIC.StagingShipScheduleAuthAccumsT
truncate table
	EDIFordIC.StagingShipSchedulesT
truncate table
	EDIFordIC.StagingPlanningHeadersT
truncate table
	EDIFordIC.StagingPlanningSupplementalT
truncate table
	EDIFordIC.StagingPlanningAccumsT
truncate table
	EDIFordIC.StagingPlanningAuthAccumsT
truncate table
	EDIFordIC.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFordIC.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIFordIC.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIFordIC.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIFordIC.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIFordIC.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIFordIC.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIFordIC.ShipSchedules sdrv
...
select
	*
from
	EDIFordIC.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIFordIC.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIFordIC.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIFordIC.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIFordIC.PlanningReleases sdrv
go
