...
CREATE procedure [EDINascote].[usp_Stage_2]
...
execute
	...
	@objname = N'EDINascote.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningReleases'
...
insert
	EDINascote.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDINascote.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDINascote.ShipScheduleSupplemental'

insert
	EDINascote.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINascote.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDINascote.ShipScheduleAccums'

insert
	EDINascote.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINascote.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDINascote.ShipScheduleAuthAccums'

insert
	EDINascote.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINascote.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDINascote.ShipSchedules'

insert
	EDINascote.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDINascote.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDINascote.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDINascote.PlanningSupplemental'

insert
	EDINascote.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINascote.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDINascote.PlanningAccums'

insert
	EDINascote.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINascote.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDINascote.PlanningAuthAccums'

insert
	EDINascote.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINascote.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDINascote.StagingPlanningReleasesT sfr
...
truncate table
	EDINascote.StagingShipScheduleHeadersT
truncate table
	EDINascote.StagingShipScheduleSupplementalT
truncate table
	EDINascote.StagingShipScheduleAccumsT
truncate table
	EDINascote.StagingShipScheduleAuthAccumsT
truncate table
	EDINascote.StagingShipSchedulesT
truncate table
	EDINascote.StagingPlanningHeadersT
truncate table
	EDINascote.StagingPlanningSupplementalT
truncate table
	EDINascote.StagingPlanningAccumsT
truncate table
	EDINascote.StagingPlanningAuthAccumsT
truncate table
	EDINascote.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINascote.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDINascote.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDINascote.ShipScheduleHeaders sdhv
...
select
	*
from
	EDINascote.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDINascote.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDINascote.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDINascote.ShipSchedules sdrv
...
select
	*
from
	EDINascote.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDINascote.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDINascote.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDINascote.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDINascote.PlanningReleases sdrv
go
