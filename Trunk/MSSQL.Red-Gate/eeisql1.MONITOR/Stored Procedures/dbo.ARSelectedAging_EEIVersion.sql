...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[ARSelectedAging_EEIVersion](@ad_asofdate datetime,@ad_selectdate datetime,@as_currency char(10)=null,@as_agedby char(10)=null,@as_sortby char(10)=null,@as_agecustomer char(10)=null)
  ...
  */
    ...
    begin
      insert into [dbo].ar_customer_aging
        ...
        select ar_headers.document_type,
          ...
          as_of_date=@ad_asofdate,
          select_date=@ad_selectdate,
          ar_headers.amount,
          ...
          and(ar_headers.document_date>'2006-01-01')
    ...
    begin
      ...
      insert into [dbo].ar_customer_aging
        ...
        select ar_headers.document_type,
          ...
          where 
          convert(char(10),ar_headers.gl_date,111) <=convert(char(10),@ad_selectdate,111)
          and ar_headers.amount<>0
          and ar_headers.intercompany<>'Y'
          and convert(char(10),ar_applications.applied_date,111) <=convert(char(10),@ad_selectdate,111)
          and ar_applications.application_type<>'OVERPY'
          and(ar_headers.ship_unit=11)
          and(ar_headers.ledger_account_code>=121011)
          and(ar_headers.document_date>'2006-01-01')
          group by ar_headers.document_type,
          ar_headers.document,
  ...
  update [dbo].ar_customer_aging set
    ...
    =IsNULL((select SUM(IsNull(ar_applications.exchanged_amount*-1,0))
      ...
      and convert(char(10),ar_applications.applied_date,111)<=convert(char(10),@ad_selectdate,111)),0)
  ...
  */
  insert into [dbo].ar_customer_aging
    ...
    select 'A',
      ...
      where bank_register.gl_date>'2006-01-01'
	  and bank_register.document_class='AR'
      ...
      and exists(select 1 from bank_register as br_voids
        ...
        and convert(char(10),br_voids.gl_date,111)  >convert(char(10),@ad_selectdate,111))))
      and(ar_applications.applied_date is null
      or convert(char(10),ar_applications.applied_date,111) <=convert(char(10),@ad_selectdate,111))
      and ar_applications.application_type not in('DISCNT','ADJUST','WRTOFF')
      and convert(char(10),bank_register.gl_date,111) <=convert(char(10),@ad_selectdate,111)
