...
Create procedure [EDIPolycon].[usp_Stage_2]
...
execute
	...
	@objname = N'EDIPolycon.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningReleases'
...
insert
	EDIPolycon.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIPolycon.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIPolycon.ShipScheduleSupplemental'

insert
	EDIPolycon.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIPolycon.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIPolycon.ShipScheduleAccums'

insert
	EDIPolycon.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIPolycon.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIPolycon.ShipScheduleAuthAccums'

insert
	EDIPolycon.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIPolycon.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIPolycon.ShipSchedules'

insert
	EDIPolycon.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIPolycon.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDIPolycon.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIPolycon.PlanningSupplemental'

insert
	EDIPolycon.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIPolycon.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIPolycon.PlanningAccums'

insert
	EDIPolycon.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIPolycon.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIPolycon.PlanningAuthAccums'

insert
	EDIPolycon.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIPolycon.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDIPolycon.StagingPlanningReleasesT sfr
...
truncate table
	EDIPolycon.StagingShipScheduleHeadersT
truncate table
	EDIPolycon.StagingShipScheduleSupplementalT
truncate table
	EDIPolycon.StagingShipScheduleAccumsT
truncate table
	EDIPolycon.StagingShipScheduleAuthAccumsT
truncate table
	EDIPolycon.StagingShipSchedulesT
truncate table
	EDIPolycon.StagingPlanningHeadersT
truncate table
	EDIPolycon.StagingPlanningSupplementalT
truncate table
	EDIPolycon.StagingPlanningAccumsT
truncate table
	EDIPolycon.StagingPlanningAuthAccumsT
truncate table
	EDIPolycon.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIPolycon.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIPolycon.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIPolycon.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIPolycon.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIPolycon.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIPolycon.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIPolycon.ShipSchedules sdrv
...
select
	*
from
	EDIPolycon.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIPolycon.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIPolycon.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIPolycon.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIPolycon.PlanningReleases sdrv
go
