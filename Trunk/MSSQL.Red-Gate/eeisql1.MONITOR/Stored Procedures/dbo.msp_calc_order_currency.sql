...
begin
	...
	from	parameters
	--Added Update to order_detail.alternate_price where != order_header.alternate_price - 2009/02/19	Andre S. Boulanger

	Update	order_detail
	set		alternate_price = order_header.alternate_price
	from		order_detail
	join		order_header on order_detail.order_no = order_header.order_no
	where	order_header.order_no = @order_no and
			order_header.order_type = 'B' and
			order_header.alternate_price != order_detail.alternate_price
