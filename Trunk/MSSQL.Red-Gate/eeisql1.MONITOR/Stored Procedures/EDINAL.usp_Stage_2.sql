...
CREATE procedure [EDINAL].[usp_Stage_2]
...
execute
	...
	@objname = N'EDINAL.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDINAL.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDINAL.ShipScheduleSupplemental'

insert
	EDINAL.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINAL.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDINAL.ShipScheduleAccums'

insert
	EDINAL.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINAL.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDINAL.ShipScheduleAuthAccums'

insert
	EDINAL.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINAL.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDINAL.ShipSchedules'

insert
	EDINAL.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDINAL.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDINAL.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDINAL.PlanningSupplemental'

insert
	EDINAL.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINAL.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDINAL.PlanningAccums'

insert
	EDINAL.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINAL.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDINAL.PlanningAuthAccums'

insert
	EDINAL.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDINAL.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDINAL.StagingPlanningReleasesT sfr
...
truncate table
	EDINAL.StagingShipScheduleHeadersT
truncate table
	EDINAL.StagingShipScheduleSupplementalT
truncate table
	EDINAL.StagingShipScheduleAccumsT
truncate table
	EDINAL.StagingShipScheduleAuthAccumsT
truncate table
	EDINAL.StagingShipSchedulesT
truncate table
	EDINAL.StagingPlanningHeadersT
truncate table
	EDINAL.StagingPlanningSupplementalT
truncate table
	EDINAL.StagingPlanningAccumsT
truncate table
	EDINAL.StagingPlanningAuthAccumsT
truncate table
	EDINAL.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDINAL.StagingPlanningReleasesT'
...
select
	*
from
	EDINAL.ShipScheduleHeaders sdhv
...
select
	*
from
	EDINAL.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDINAL.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDINAL.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDINAL.ShipSchedules sdrv
...
select
	*
from
	EDINAL.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDINAL.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDINAL.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDINAL.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDINAL.PlanningReleases sdrv
go
