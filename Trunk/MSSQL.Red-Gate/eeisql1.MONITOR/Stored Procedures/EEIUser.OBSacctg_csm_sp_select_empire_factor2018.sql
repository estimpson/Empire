...
CREATE procedure [EEIUser].[OBSacctg_csm_sp_select_empire_factor2018] 
...
select @suggested_take_rate = (	  select (case b.total_2018 when 0 then 0 else round(a.total_2018/b.total_2018,2) end)
