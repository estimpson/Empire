...
CREATE Procedure [dbo].[eeisp_ScrapLostBySerial_PartChange] 
 ...
 as
-- exec [dbo].[eeisp_ScrapLostBySerial_PartChange] '14', '2016-04-13 00:00:00', 'AUT0106-HG04', 'AUT0106-HH00'

--AUT0105-HF04 – now HG00
--AUT0106-HG04 – now HH00
--AUT0107-HJ04 -   now  HK00
--AUT0108-HJ04 -   now HK00
...
Delete serialstoscrap

Insert serialstoscrap
(serial)

Select Serial From object where part = @OldPart
...
insert	audit_trail (
	...
	select	object.serial,
		...
		object.custom5,
		object.plant,
		'Part change from  ' + @OldPart + ' to ' + @NewPart,
		'11',
		object.package_type,
		object.suffix,
		object.date_due,
...
set
	o.part = @NewPart
,	o.cost = ps.material_cum
,	o.std_cost = ps.material_cum
from
	dbo.object o
...
where
	o.serial in 
		(select serial from dbo.serialstoscrap s)
	
	
--For manual add transaction
insert	audit_trail (
	serial,
	date_stamp,
	type,
