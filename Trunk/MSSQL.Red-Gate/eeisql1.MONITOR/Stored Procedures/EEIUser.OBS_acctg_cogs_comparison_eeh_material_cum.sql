...
CREATE procedure [EEIUser].[OBS_acctg_cogs_comparison_eeh_material_cum]	(
											@fiscal_year1 int,					
											@period1 int,
											@fiscal_year2 int,
											@period2 int
...
Select		@fiscal_year1 = 2018
Select		@period1 = 10
Select		@fiscal_year2 = 2019
Select		@period2 = 2*/
...
where		fiscal_year = @fiscal_year1 
		...
		and part_historical_daily.reason <> 'Global Rollup'
