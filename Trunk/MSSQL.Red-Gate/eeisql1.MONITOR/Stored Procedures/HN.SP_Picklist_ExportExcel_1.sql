...
CREATE PROC [HN].[SP_Picklist_ExportExcel_1]
	(@Operator varchar(25),
	 @ShipperID int ,
...
*/
	...
	Delete
	from HN.Picklist_RF_DataExcel_SerialDetails
	where	operator=@operator and ShipperID = @ShipperID
	...
	Insert into HN.Picklist_RF_DataExcel_SerialDetails
	Select	@operator, @ShipperID, fn_PickList_SerialDetail_ByShipper.*
	from	[HN].[fn_PickList_SerialDetail_ByShipper](@ShipperID, @Plant, @IsFullStandardPack,null) fn_PickList_SerialDetail_ByShipper
