...
Create procedure [EDIFnG].[usp_Stage_2]
...
execute
	...
	@objname = N'EDIFnG.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDIFnG.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIFnG.ShipScheduleSupplemental'

insert
	EDIFnG.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnG.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIFnG.ShipScheduleAccums'

insert
	EDIFnG.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnG.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFnG.ShipScheduleAuthAccums'

insert
	EDIFnG.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnG.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFnG.ShipSchedules'

insert
	EDIFnG.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIFnG.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDIFnG.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIFnG.PlanningSupplemental'

insert
	EDIFnG.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnG.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIFnG.PlanningAccums'

insert
	EDIFnG.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnG.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFnG.PlanningAuthAccums'

insert
	EDIFnG.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnG.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDIFnG.StagingPlanningReleasesT sfr
...
truncate table
	EDIFnG.StagingShipScheduleHeadersT
truncate table
	EDIFnG.StagingShipScheduleSupplementalT
truncate table
	EDIFnG.StagingShipScheduleAccumsT
truncate table
	EDIFnG.StagingShipScheduleAuthAccumsT
truncate table
	EDIFnG.StagingShipSchedulesT
truncate table
	EDIFnG.StagingPlanningHeadersT
truncate table
	EDIFnG.StagingPlanningSupplementalT
truncate table
	EDIFnG.StagingPlanningAccumsT
truncate table
	EDIFnG.StagingPlanningAuthAccumsT
truncate table
	EDIFnG.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnG.StagingPlanningReleasesT'
...
select
	*
from
	EDIFnG.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIFnG.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIFnG.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIFnG.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIFnG.ShipSchedules sdrv
...
select
	*
from
	EDIFnG.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIFnG.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIFnG.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIFnG.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIFnG.PlanningReleases sdrv
go
