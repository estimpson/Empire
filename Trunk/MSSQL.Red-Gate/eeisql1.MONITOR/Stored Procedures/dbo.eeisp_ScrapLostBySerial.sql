...
CREATE Procedure [dbo].[eeisp_ScrapLostBySerial] (	@OperatorPWD varchar(10), @transdate datetime,
						@Result integer = 0 output)
 as
-- exec [dbo].[eeisp_ScrapLostByLocationAndValue] '14', '2010-12-15 14:00:00'
