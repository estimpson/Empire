...
Create procedure [EDIVIST].[usp_Stage_2]
...
execute
	...
	@objname = N'EDIVIST.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDIVIST.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIVIST.ShipScheduleSupplemental'

insert
	EDIVIST.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVIST.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIVIST.ShipScheduleAccums'

insert
	EDIVIST.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVIST.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIVIST.ShipScheduleAuthAccums'

insert
	EDIVIST.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVIST.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIVIST.ShipSchedules'

insert
	EDIVIST.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIVIST.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDIVIST.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIVIST.PlanningSupplemental'

insert
	EDIVIST.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVIST.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIVIST.PlanningAccums'

insert
	EDIVIST.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVIST.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIVIST.PlanningAuthAccums'

insert
	EDIVIST.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVIST.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDIVIST.StagingPlanningReleasesT sfr
...
truncate table
	EDIVIST.StagingShipScheduleHeadersT
truncate table
	EDIVIST.StagingShipScheduleSupplementalT
truncate table
	EDIVIST.StagingShipScheduleAccumsT
truncate table
	EDIVIST.StagingShipScheduleAuthAccumsT
truncate table
	EDIVIST.StagingShipSchedulesT
truncate table
	EDIVIST.StagingPlanningHeadersT
truncate table
	EDIVIST.StagingPlanningSupplementalT
truncate table
	EDIVIST.StagingPlanningAccumsT
truncate table
	EDIVIST.StagingPlanningAuthAccumsT
truncate table
	EDIVIST.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVIST.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIVIST.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIVIST.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIVIST.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIVIST.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIVIST.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIVIST.ShipSchedules sdrv
...
select
	*
from
	EDIVIST.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIVIST.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIVIST.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIVIST.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIVIST.PlanningReleases sdrv
go
