...
create procedure [dbo].[OBS_dw_eehsp_rpt_inventory_change200604b]
...
-- Populate the table
	...
	Insert			#SelectedMonitorTransactions
		...
		select		audit_trail.serial,
					...
					(audit_trail.quantity*part_standard_copy_20060430.material_cum),
					audit_trail.user_defined_status

		from		audit_trail

		left outer join	part_copy_20060430 on audit_trail.part = part_copy_20060430.part
		left outer join	part_standard_copy_20060430 on audit_trail.part = part_standard_copy_20060430.part

		where		audit_trail.date_stamp >= '2006-04-01 00:00:00' and
					audit_trail.date_stamp < '2006-05-01 00:00:00' and
					...
					part_copy_20060430.type not in ('R','W','')
...
-- Add product_line
	...
	Update			Acctg_ActivityComparison
		...
		set			ProductLine = part_copy_20060430.product_line
			
		from		part_copy_20060430, Acctg_ActivityComparison

		where		Acctg_ActivityComparison.part = part_copy_20060430.part
...
-- Select *, GLExtCost-AuditExtCost as difference from ActivityComparison
