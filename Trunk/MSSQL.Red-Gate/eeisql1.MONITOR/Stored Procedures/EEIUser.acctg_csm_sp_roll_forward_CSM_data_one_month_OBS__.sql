...
CREATE procedure [EEIUser].[acctg_csm_sp_roll_forward_CSM_data_one_month_OBS??] 
...
-- select @prior_release_id = '2019-02'

-- declare @current_release_id varchar(10)
-- select @current_release_id = '2019-03'
...
-- delete from eeiuser.acctg_csm_material_cost_tabular where release_id in ('2019-01','2019-02','2019-03')
...
-- delete from eeiuser.acctg_csm_naihs where release_id in ('2019-01','2019-02','2019-03') and version = 'Empire Factor'
...
-- delete from eeiuser.acctg_csm_naihs where release_id in ('2019-01','2019-02','2019-03') and version = 'Empire Adjustment'
