...
SET ANSI_NULLS ON
GO
CREATE procedure [EDIFnGMex].[usp_Stage_2]
...
set	@ProcName = user_name(objectproperty(@@procid, 'OwnerId')) + '.' + object_name(@@procid)  -- e.g. EDIFnGMex.usp_Test
--- </Error Handling>
...
execute
	...
	@objname = N'EDIFnGMex.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningReleases'
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.ShipScheduleHeaders'

insert
	EDIFnGMex.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIFnGMex.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.ShipScheduleSupplemental'

insert
	EDIFnGMex.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnGMex.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.ShipScheduleAccums'

insert
	EDIFnGMex.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnGMex.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.ShipScheduleAuthAccums'

insert
	EDIFnGMex.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnGMex.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.ShipSchedules'

insert
	EDIFnGMex.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIFnGMex.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.PlanningHeaders'

insert
	EDIFnGMex.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIFnGMex.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.PlanningSupplemental'

insert
	EDIFnGMex.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnGMex.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.PlanningAccums'

insert
	EDIFnGMex.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnGMex.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.PlanningAuthAccums'

insert
	EDIFnGMex.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIFnGMex.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDIFnGMex.PlanningReleases'

insert
	EDIFnGMex.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDIFnGMex.StagingPlanningReleasesT sfr
...
truncate table
	EDIFnGMex.StagingShipScheduleHeadersT
truncate table
	EDIFnGMex.StagingShipScheduleSupplementalT
truncate table
	EDIFnGMex.StagingShipScheduleAccumsT
truncate table
	EDIFnGMex.StagingShipScheduleAuthAccumsT
truncate table
	EDIFnGMex.StagingShipSchedulesT
truncate table
	EDIFnGMex.StagingPlanningHeadersT
truncate table
	EDIFnGMex.StagingPlanningSupplementalT
truncate table
	EDIFnGMex.StagingPlanningAccumsT
truncate table
	EDIFnGMex.StagingPlanningAuthAccumsT
truncate table
	EDIFnGMex.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIFnGMex.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIFnGMex.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIFnGMex.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIFnGMex.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIFnGMex.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIFnGMex.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIFnGMex.ShipSchedules sdrv
...
select
	*
from
	EDIFnGMex.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIFnGMex.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIFnGMex.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIFnGMex.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIFnGMex.PlanningReleases sdrv
go
