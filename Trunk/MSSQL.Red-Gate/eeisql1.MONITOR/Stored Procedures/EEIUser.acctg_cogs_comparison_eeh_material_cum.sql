...
left	join (Select	part eehpart,
				material_cum eeh_material_cum1
from		[EEHSQL1].[Historicaldata].[dbo].part_standard_historical_daily eehpartstandard
where	eehpartstandard.time_stamp =@eehpsh_time1 ) eehps on PartList.part = eehpart
left	join (Select	part eehpart2,
				material_cum eeh_material_cum2
from		[EEHSQL1].[Historicaldata].[dbo].part_standard_historical_daily eehpartstandard2
