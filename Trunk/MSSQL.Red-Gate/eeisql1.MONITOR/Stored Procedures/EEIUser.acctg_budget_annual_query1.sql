...
CREATE procedure [EEIUser].[acctg_budget_annual_query1] (@budget_id varchar(50), @fiscal_year varchar(5), @user_id varchar(50), @ledger_account varchar(50))
as
declare @period1 int
,@period2 int
,@period3 int
...
select distinct(budget_line),budget_id, ledger_account, cashflow, budget_description from eeiuser.acctg_budget where budget_id = @budget_id and ledger_account = @ledger_account 
