...
SET ANSI_NULLS ON
GO
CREATE procedure [dbo].[cdisp_ford_asn_container_original_fxDelete] (@shipper int) as
BEGIN
...
GO
GRANT EXECUTE ON  [dbo].[cdisp_ford_asn_container_original_fxDelete] TO [public]
GO
