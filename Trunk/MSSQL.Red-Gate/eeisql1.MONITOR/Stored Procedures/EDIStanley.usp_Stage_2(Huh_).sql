...
SET ANSI_NULLS ON
GO
CREATE procedure [EDIStanley].[usp_Stage_2(Huh?)]
...
execute
	...
	@objname = N'EDIStanley.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDIStanley.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIStanley.ShipScheduleSupplemental'

insert
	EDIStanley.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIStanley.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIStanley.ShipScheduleAccums'

insert
	EDIStanley.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIStanley.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIStanley.ShipScheduleAuthAccums'

insert
	EDIStanley.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIStanley.StagingShipScheduleAuthAccumsT sfr
...
select
      ...
      ,[ReleaseDT]
from
	EDIStanley.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDIStanley.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIStanley.PlanningSupplemental'

insert
	EDIStanley.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIStanley.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIStanley.PlanningAccums'

insert
	EDIStanley.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIStanley.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIStanley.PlanningAuthAccums'

insert
	EDIStanley.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIStanley.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDIStanley.StagingPlanningReleasesT sfr
...
truncate table
	EDIStanley.StagingShipScheduleHeadersT
truncate table
	EDIStanley.StagingShipScheduleSupplementalT
truncate table
	EDIStanley.StagingShipScheduleAccumsT
truncate table
	EDIStanley.StagingShipScheduleAuthAccumsT
truncate table
	EDIStanley.StagingShipSchedulesT
truncate table
	EDIStanley.StagingPlanningHeadersT
truncate table
	EDIStanley.StagingPlanningSupplementalT
truncate table
	EDIStanley.StagingPlanningAccumsT
truncate table
	EDIStanley.StagingPlanningAuthAccumsT
truncate table
	EDIStanley.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIStanley.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIStanley.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIStanley.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIStanley.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIStanley.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIStanley.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIStanley.ShipSchedules sdrv
...
select
	*
from
	EDIStanley.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIStanley.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIStanley.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIStanley.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIStanley.PlanningReleases sdrv
go
