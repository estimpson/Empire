...
SET ANSI_NULLS ON
GO
CREATE procedure [FxPVQ].[usp_EditPartVendorQuote]
	@User varchar(5)
,	@RowID int
...
begin
	...
	begin try
		...
		--- <Body>
		/*	Update part/vendor/quote record. */
		set @TocMsg = 'Update part/vendor/quote record.'
		--- <Update rows="1">
...
declare
	@User varchar(5) = 'EES'
,	@RowID int = 18
,	@VendorCode varchar(10) = 'GENPOLYMER'
,	@PartCode varchar(25) = '12059183'
,	@Oem varchar(35) = 'GM'
,	@EffectiveDate datetime = null
,	@EndDate datetime = '2018-09-20'
,	@Price decimal(10,6) = null
...
execute
	@ProcReturn = FxPVQ.usp_EditPartVendorQuote
	@User = @User
,	@RowID = @RowID
,	@VendorCode = @VendorCode
,	@PartCode = @PartCode
