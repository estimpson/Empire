...
sum([Nov 2020]) as [Oct 2020],
sum([Dec 2020]) as [Dec 2020],
sum([total_2020]) as [total_2020],

sum([Jan 2021]) as [Jan 2021],
sum([Feb 2021]) as [Feb 2021],
sum([Mar 2021]) as [Mar 2021],
sum([Apr 2021]) as [Apr 2021],
sum([May 2021]) as [May 2021],
sum([Jun 2021]) as [Jun 2021],
sum([Jul 2021]) as [Jul 2021],
sum([Aug 2021]) as [Aug 2021],
sum([Sep 2021]) as [Sep 2021],
sum([Oct 2021]) as [Oct 2021],
sum([Nov 2021]) as [Oct 2021],
sum([Dec 2021]) as [Dec 2021],
sum([total_2021]) as [total_2021],

/*
sum([Jan 2022]) as [Jan 2022],
sum([Feb 2022]) as [Feb 2022],
sum([Mar 2022]) as [Mar 2022],
sum([Apr 2022]) as [Apr 2022],
sum([May 2022]) as [May 2022],
sum([Jun 2022]) as [Jun 2022],
sum([Jul 2022]) as [Jul 2022],
sum([Aug 2022]) as [Aug 2022],
sum([Sep 2022]) as [Sep 2022],
sum([Oct 2022]) as [Oct 2022],
sum([Nov 2022]) as [Oct 2022],
sum([Dec 2022]) as [Dec 2022],
...
/*
sum(jan_22) as [Jan 202],
sum(feb_22) as [Feb 202],
sum(mar_22) as [Mar 202],
sum(apr_22) as [Apr 202],
sum(may_22) as [May 202],
sum(jun_22) as [Jun 202],
sum(jul_22) as [Jul 202],
sum(aug_22) as [Aug 202],
sum(sep_22) as [Sep 202],
sum(oct_22) as [Oct 202],
sum(nov_22) as [Nov 202],
sum(dec_22) as [Dec 202],
...
select @suggested_take_rate = (	  select (case b.total_2019 when 0 then 0 else round(a.total_2019/b.total_2019,2) end)
								*(	select	avg(take_rate) 
									from	eeiuser.acctg_csm_base_part_mnemonic c
									where	release_id = @release_id 
									and	c.base_part = a.base_part and c.forecast_id = 'C') from @actual a 
								join @forecast b on a.base_part = b.base_part )
