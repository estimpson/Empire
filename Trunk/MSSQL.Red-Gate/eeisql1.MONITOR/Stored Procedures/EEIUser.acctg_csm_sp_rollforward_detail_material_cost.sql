...
CREATE procedure [EEIUser].[acctg_csm_sp_rollforward_detail_material_cost]
...
,	d.MaterialCost
from
	eeiuser.acctg_csm_material_cost_detail d
	join eeiuser.acctg_csm_material_cost_header h
