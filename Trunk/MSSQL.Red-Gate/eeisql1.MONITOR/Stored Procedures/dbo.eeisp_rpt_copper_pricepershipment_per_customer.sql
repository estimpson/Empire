...
create procedure	[dbo].[eeisp_rpt_copper_pricepershipment_per_customer] (@customerprefix varchar(5), @startdate datetime, @enddate datetime, @lookbackmonthspan integer, @intialshipmentlookback integer)
