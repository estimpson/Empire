...
--exec eeiuser.eep_putaway_reconciliation_1 '12494','12495','12496', NULL, NULL

CREATE procedure [EEIUser].[EEP_Putaway_Reconciliation_1] (@shipper1 varchar(25), @shipper2 varchar(25), @shipper3 varchar(25), @shipper4 varchar(25), @shipper5 varchar(25))
