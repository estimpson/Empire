...
CREATE PROCEDURE [dbo].[CDIsp_asn_detail_serial_visteon] ( @SHIPPER INTEGER )
AS --[dbo].[CDIsp_asn_detail_serial_visteon] 47715 
    BEGIN
        ...
        ORDER BY dbo.shipper_detail.customer_part ASC ,
                #atr_package_type.package_type ASC ,
                CEILING(#atr_objects.serialcounter/200.1) ASC ,
                serial ASC 
    END
