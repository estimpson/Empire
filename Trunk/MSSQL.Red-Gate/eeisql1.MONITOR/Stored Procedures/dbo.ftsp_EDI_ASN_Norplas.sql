...
CREATE PROCEDURE [dbo].[ftsp_EDI_ASN_Norplas] @Shipper INT   AS
BEGIN

--exec ftsp_EDI_ASN_Norplas 86336 83339
...
SELECT	@TradingPartner = COALESCE(NULLIF(trading_partner_code,''), 'Formet Testing'),
				...
				@MaterialIssuerName = 'NORPLAS INDUSTRIES INC.',
