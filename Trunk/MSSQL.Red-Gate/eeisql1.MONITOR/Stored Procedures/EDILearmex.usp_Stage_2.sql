...
CREATE procedure [EDILearmex].[usp_Stage_2]
...
set	@ProcName = user_name(objectproperty(@@procid, 'OwnerId')) + '.' + object_name(@@procid)  -- e.g. EDILearmex.usp_Test
--- </Error Handling>
...
execute
	...
	@objname = N'EDILearmex.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningReleases'
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.ShipScheduleHeaders'

insert
	EDILearmex.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDILearmex.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.ShipScheduleSupplemental'

insert
	EDILearmex.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDILearmex.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.ShipScheduleAccums'

insert
	EDILearmex.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDILearmex.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.ShipScheduleAuthAccums'

insert
	EDILearmex.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDILearmex.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.ShipSchedules'

insert
	EDILearmex.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDILearmex.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.PlanningHeaders'

insert
	EDILearmex.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDILearmex.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.PlanningSupplemental'

insert
	EDILearmex.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDILearmex.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.PlanningAccums'

insert
	EDILearmex.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDILearmex.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.PlanningAuthAccums'

insert
	EDILearmex.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDILearmex.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDILearmex.PlanningReleases'

insert
	EDILearmex.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDILearmex.StagingPlanningReleasesT sfr
...
truncate table
	EDILearmex.StagingShipScheduleHeadersT
truncate table
	EDILearmex.StagingShipScheduleSupplementalT
truncate table
	EDILearmex.StagingShipScheduleAccumsT
truncate table
	EDILearmex.StagingShipScheduleAuthAccumsT
truncate table
	EDILearmex.StagingShipSchedulesT
truncate table
	EDILearmex.StagingPlanningHeadersT
truncate table
	EDILearmex.StagingPlanningSupplementalT
truncate table
	EDILearmex.StagingPlanningAccumsT
truncate table
	EDILearmex.StagingPlanningAuthAccumsT
truncate table
	EDILearmex.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDILearmex.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDILearmex.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDILearmex.ShipScheduleHeaders sdhv
...
select
	*
from
	EDILearmex.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDILearmex.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDILearmex.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDILearmex.ShipSchedules sdrv
...
select
	*
from
	EDILearmex.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDILearmex.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDILearmex.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDILearmex.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDILearmex.PlanningReleases sdrv
go
