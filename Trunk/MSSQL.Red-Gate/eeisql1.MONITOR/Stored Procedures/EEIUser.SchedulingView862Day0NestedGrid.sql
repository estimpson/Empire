...
CREATE procedure [EEIUser].[SchedulingView862Day0NestedGrid] @Day0ReleaseNo varchar(30)

-- exec eeiuser.SchedulingView862Day0NestedGrid 'KR00000082450626'
...
select		s.id, s.status, s.date_shipped, s.bill_of_lading_number, s.customer, s.destination, 
			...
			sd.release_no, sd.part_original, sd.customer_part, ran.qty, ran.rannumber as Day0ReleaseNo
...
where	ran.RanNumber = @Day0ReleaseNo
