...
CREATE procedure [EDIValeoMex].[usp_Stage_2]
...
set	@ProcName = user_name(objectproperty(@@procid, 'OwnerId')) + '.' + object_name(@@procid)  -- e.g. EDIValeoMex.usp_Test
--- </Error Handling>
...
execute
	...
	@objname = N'EDIValeoMex.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningReleases'
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.ShipScheduleHeaders'

insert
	EDIValeoMex.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIValeoMex.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.ShipScheduleSupplemental'

insert
	EDIValeoMex.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIValeoMex.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.ShipScheduleAccums'

insert
	EDIValeoMex.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIValeoMex.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.ShipScheduleAuthAccums'

insert
	EDIValeoMex.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIValeoMex.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.ShipSchedules'

insert
	EDIValeoMex.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIValeoMex.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.PlanningHeaders'

insert
	EDIValeoMex.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIValeoMex.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.PlanningSupplemental'

insert
	EDIValeoMex.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIValeoMex.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.PlanningAccums'

insert
	EDIValeoMex.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIValeoMex.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.PlanningAuthAccums'

insert
	EDIValeoMex.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIValeoMex.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDIValeoMex.PlanningReleases'

insert
	EDIValeoMex.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDIValeoMex.StagingPlanningReleasesT sfr
...
truncate table
	EDIValeoMex.StagingShipScheduleHeadersT
truncate table
	EDIValeoMex.StagingShipScheduleSupplementalT
truncate table
	EDIValeoMex.StagingShipScheduleAccumsT
truncate table
	EDIValeoMex.StagingShipScheduleAuthAccumsT
truncate table
	EDIValeoMex.StagingShipSchedulesT
truncate table
	EDIValeoMex.StagingPlanningHeadersT
truncate table
	EDIValeoMex.StagingPlanningSupplementalT
truncate table
	EDIValeoMex.StagingPlanningAccumsT
truncate table
	EDIValeoMex.StagingPlanningAuthAccumsT
truncate table
	EDIValeoMex.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIValeoMex.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIValeoMex.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIValeoMex.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIValeoMex.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIValeoMex.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIValeoMex.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIValeoMex.ShipSchedules sdrv
...
select
	*
from
	EDIValeoMex.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIValeoMex.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIValeoMex.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIValeoMex.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIValeoMex.PlanningReleases sdrv
go
