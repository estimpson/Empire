...
CREATE procedure [EEIUser].[acctg_csm_new_vehicle_launches_head_lamp] (@year varchar(4))
as
begin

-- exec eeiuser.acctg_csm_new_vehicle_launches_head_lamp '2019'
...
insert into @temp1
	select  ([VP: Program]+' '+[VP: Production Brand]+ ' '+[VP: Production Nameplate]) as program_mnemonic,
			...
			[HeadLamp Supplier Group], 
			[HeadLamp Supplier]
	from eeiuser.acctg_csm_study_forward_lighting
	where release_id = (select [dbo].[fn_ReturnLatestCSMForwardLightingRelease] () )
...
select	a.manufacturer,
		...
		a.[2025 Vehicle EAU],
		a.[2026 Vehicle EAU],
		a.[2019 Vehicle EAU]*2 as [2019 Head Lamp EAU],
		a.[2020 Vehicle EAU]*2 as [2020 Head Lamp EAU],
		a.[2021 Vehicle EAU]*2 as [2021 Head Lamp EAU],
		a.[2022 Vehicle EAU]*2 as [2022 Head Lamp EAU],
		a.[2023 Vehicle EAU]*2 as [2023 Head Lamp EAU],
		a.[2024 Vehicle EAU]*2 as [2024 Head Lamp EAU],
		a.[2025 Vehicle EAU]*2 as [2025 Head Lamp EAU],
		a.[2026 Vehicle EAU]*2 as [2026 Head Lamp EAU],
...
(	select	program
	 ...
	 where	empire_market_subsegment = ''Head Lamp''
