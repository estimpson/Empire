...
SET ANSI_NULLS ON
GO
CREATE procedure [EEIUser].[usp_Quoting_DeleteAttachment]
...
begin
	...
	,	InArguments =
			...
			+ ', @AttachmentCategory = ' + coalesce('''' + @AttachmentCategory + '''', '<null>')
	...
	begin try
		...
		begin
			--- <Call>	
			set	@CallProcName = ' EEISQL2.FxUtilities.FS.usp_QT_Files_DeleteAttachment'
			
			execute @ProcReturn = EEISQL2.FxUtilities.FS.usp_QT_Files_DeleteAttachment
