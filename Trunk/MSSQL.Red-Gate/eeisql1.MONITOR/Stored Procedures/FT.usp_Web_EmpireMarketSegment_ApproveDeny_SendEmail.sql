...
CREATE procedure [FT].[usp_Web_EmpireMarketSegment_ApproveDeny_SendEmail]
...
,	@EmailHeader nvarchar(max) = 'Empire Market Segment Request' 

select
	@EmailBody =  
	N'Empire Market Segment ' + @EmpireMarketSegment +
	N' has been ' +
	@ApprovedDenied +
	N'.' +
	N'<br /><br />' + 
