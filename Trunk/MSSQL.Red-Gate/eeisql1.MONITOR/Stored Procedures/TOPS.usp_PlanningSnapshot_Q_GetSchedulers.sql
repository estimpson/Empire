...
CREATE procedure [TOPS].[usp_PlanningSnapshot_Q_GetSchedulers]
...
begin
	...
	begin try
		...
		begin
			...
			declare
				@tempScheduling table
				(	FinishedPart varchar(30)
				,	Revision char(9)
				,	SchedulerID varchar(10)
			...
			exec TOPS.usp_PlanningSnapshot_Q_CurrentPartList
				@TranDT = @TranDT out
			,	@Result = @Result out
			,	@Debug = @Debug
