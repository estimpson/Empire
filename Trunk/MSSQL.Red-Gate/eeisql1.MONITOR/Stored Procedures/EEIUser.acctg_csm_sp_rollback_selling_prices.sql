...
CREATE procedure [EEIUser].[acctg_csm_sp_rollback_selling_prices]
...
--- <Body>
-- Step 1: roll back Selling Prices data one month in the detail table (which will fire a trigger to roll back the legacy table)
---<Delete>
...
-- Step 2: roll back Selling Prices data one month in the header table
---<Delete>
