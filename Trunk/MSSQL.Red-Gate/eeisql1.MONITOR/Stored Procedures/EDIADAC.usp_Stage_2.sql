...
CREATE procedure [EDIADAC].[usp_Stage_2]
...
execute
	...
	@objname = N'EDIADAC.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDIADAC.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIADAC.ShipScheduleSupplemental'

insert
	EDIADAC.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIADAC.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIADAC.ShipScheduleAccums'

insert
	EDIADAC.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIADAC.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIADAC.ShipScheduleAuthAccums'

insert
	EDIADAC.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIADAC.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIADAC.ShipSchedules'
...
select
      ...
      ,[ReleaseDT]
from
	EDIADAC.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDIADAC.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIADAC.PlanningSupplemental'

insert
	EDIADAC.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIADAC.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIADAC.PlanningAccums'

insert
	EDIADAC.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIADAC.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIADAC.PlanningAuthAccums'

insert
	EDIADAC.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIADAC.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDIADAC.StagingPlanningReleasesT sfr
...
truncate table
	EDIADAC.StagingShipScheduleHeadersT
truncate table
	EDIADAC.StagingShipScheduleSupplementalT
truncate table
	EDIADAC.StagingShipScheduleAccumsT
truncate table
	EDIADAC.StagingShipScheduleAuthAccumsT
truncate table
	EDIADAC.StagingShipSchedulesT
truncate table
	EDIADAC.StagingPlanningHeadersT
truncate table
	EDIADAC.StagingPlanningSupplementalT
truncate table
	EDIADAC.StagingPlanningAccumsT
truncate table
	EDIADAC.StagingPlanningAuthAccumsT
truncate table
	EDIADAC.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIADAC.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIADAC.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIADAC.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIADAC.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIADAC.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIADAC.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIADAC.ShipSchedules sdrv
...
select
	*
from
	EDIADAC.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIADAC.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIADAC.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIADAC.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIADAC.PlanningReleases sdrv
go
