...
CREATE procedure [EEIUser].[SchedulingView862Day3NestedGrid] @Day3ReleaseNo varchar(30)

-- exec eeiuser.SchedulingView862Day3NestedGrid 'KR00000082450626'
...
select		s.id, s.status, s.date_shipped, s.bill_of_lading_number, s.customer, s.destination, 
			...
			sd.release_no, sd.part_original, sd.customer_part, ran.qty, ran.rannumber as Day3ReleaseNo
...
where	ran.RanNumber = @Day3ReleaseNo
