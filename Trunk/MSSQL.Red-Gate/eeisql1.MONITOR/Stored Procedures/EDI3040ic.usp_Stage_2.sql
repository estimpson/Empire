...
CREATE procedure [EDI3040ic].[usp_Stage_2]
...
execute
	...
	@objname = N'EDI3040ic.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningReleases'
...
,	sfh.DocumentDT
from
	EDI3040ic.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3040ic.ShipScheduleSupplemental'

insert
	EDI3040ic.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040ic.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3040ic.ShipScheduleAccums'

insert
	EDI3040ic.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040ic.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3040ic.ShipScheduleAuthAccums'

insert
	EDI3040ic.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040ic.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3040ic.ShipSchedules'

insert
	EDI3040ic.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDI3040ic.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3040ic.PlanningHeaders'

insert
	EDI3040ic.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDI3040ic.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDI3040ic.PlanningSupplemental'

insert
	EDI3040ic.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040ic.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3040ic.PlanningAccums'

insert
	EDI3040ic.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040ic.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDI3040ic.PlanningAuthAccums'

insert
	EDI3040ic.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDI3040ic.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDI3040ic.PlanningReleases'

insert
	EDI3040ic.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDI3040ic.StagingPlanningReleasesT sfr
...
truncate table
	EDI3040ic.StagingShipScheduleHeadersT
truncate table
	EDI3040ic.StagingShipScheduleSupplementalT
truncate table
	EDI3040ic.StagingShipScheduleAccumsT
truncate table
	EDI3040ic.StagingShipScheduleAuthAccumsT
truncate table
	EDI3040ic.StagingShipSchedulesT
truncate table
	EDI3040ic.StagingPlanningHeadersT
truncate table
	EDI3040ic.StagingPlanningSupplementalT
truncate table
	EDI3040ic.StagingPlanningAccumsT
truncate table
	EDI3040ic.StagingPlanningAuthAccumsT
truncate table
	EDI3040ic.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDI3040ic.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDI3040ic.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDI3040ic.ShipScheduleHeaders sdhv
...
select
	*
from
	EDI3040ic.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDI3040ic.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDI3040ic.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDI3040ic.ShipSchedules sdrv
...
select
	*
from
	EDI3040ic.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDI3040ic.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDI3040ic.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDI3040ic.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDI3040ic.PlanningReleases sdrv
go
