...
create procedure [EEIUser].[acctg_csm_sp_select_total_demand2019]
...
select	@base_part as [BasePart],
		...
		/*
		XX.[Jan2022]+YY.[Jan2022] as [Jan2022],
		XX.[Feb2022]+YY.[Feb2022] as [Feb2022],
		XX.[Mar2022]+YY.[Mar2022] as [Mar2022],
		XX.[Apr2022]+YY.[Apr2022] as [Apr2022],
		XX.[May2022]+YY.[May2022] as [May2022],
		XX.[Jun2022]+YY.[Jun2022] as [Jun2022],
		XX.[Jul2022]+YY.[Jul2022] as [Jul2022],
		XX.[Aug2022]+YY.[Aug2022] as [Aug2022],
		XX.[Sep2022]+YY.[Sep2022] as [Sep2022],
		XX.[Oct2022]+YY.[Oct2022] as [Oct2022],
		XX.[Nov2022]+YY.[Nov2022] as [Nov2022],
		XX.[Dec2022]+YY.[Dec2022] as [Dec2022],
		((XX.[Jan2022]+YY.[Jan2022])+(XX.[Feb2022]+YY.[Feb2022])+(XX.[Mar2022]+YY.[Mar2022])+(XX.[Apr2022]+YY.[Apr2022])+(XX.[May2022]+YY.[May2022])+(XX.[Jun2022]+YY.[Jun2022])+(XX.[Jul2022]+YY.[Jul2022])+(XX.[Aug2022]+YY.[Aug2022])+(XX.[Sep2022]+YY.[Sep2022])+(XX.[Oct2022]+YY.[Oct2022])+(XX.[Nov2022]+YY.[Nov2022])+(XX.[Dec2022]+YY.[Dec2022])) as [Total_2022],
		*/
		...
		XX.[total_2026]+YY.[total_2026] as [total_2026]
