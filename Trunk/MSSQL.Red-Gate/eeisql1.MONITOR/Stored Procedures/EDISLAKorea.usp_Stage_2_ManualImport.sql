...
CREATE procedure [EDISLAKorea].[usp_Stage_2_ManualImport]
	@Release varchar(50) 
...
if not exists
	...
	insert into
		EDISLAKorea.PlanningHeaders_ManualImport
	(
		Release
	,	RawDocumentGUID
	,	Status
...
-- <Validate>
set			@CallProcName = 'dbo.usp_Validate_PlanningReleaseManualImport'
execute		@ProcReturn = dbo.usp_Validate_PlanningReleaseManualImport
...
if not exists
	...
	insert into
	EDISLAKorea.PlanningReleases_ManualImport
	(
			Status
		,	Type
		,	RawDocumentGUID
