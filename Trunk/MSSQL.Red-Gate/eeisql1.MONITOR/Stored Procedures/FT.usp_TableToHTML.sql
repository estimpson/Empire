...
--SELECT failed because the following SET options have incorrect settings: 'CONCAT_NULL_YIELDS_NULL, ANSI_PADDING'. Verify that SET options are correct for use with indexed views and/or index
