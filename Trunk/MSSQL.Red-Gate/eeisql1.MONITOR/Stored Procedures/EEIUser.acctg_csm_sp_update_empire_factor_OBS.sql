...
CREATE procedure [EEIUser].[acctg_csm_sp_update_empire_factor_OBS] 
...
set		
		...
		,[Jan 2019] = ISNULL(@Total_2019 ,0) 
		,[Feb 2019] = ISNULL(@Total_2019 ,0) 
		,[Mar 2019] = ISNULL(@Total_2019 ,0)  
		,[Apr 2019] = ISNULL(@Total_2019 ,0) 
		,[May 2019] = ISNULL(@Total_2019 ,0)  
		,[Jun 2019] = ISNULL(@Total_2019 ,0) 
		,[Jul 2019] = ISNULL(@Total_2019 ,0) 
		,[Aug 2019] = ISNULL(@Total_2019 ,0)  
		,[Sep 2019] = ISNULL(@Total_2019 ,0) 
		,[Oct 2019] = ISNULL(@Total_2019 ,0) 
		,[Nov 2019] = ISNULL(@Total_2019 ,0) 
		,[Dec 2019] = ISNULL(@Total_2019 ,0) 
		,[CY 2019] = ISNULL(@Total_2019 ,0) 

		,[CY 2020] = ISNULL(@Total_2020 ,0) 
		,[CY 2021] = ISNULL(@TOTAL_2020 ,0)
		,[CY 2022] = ISNULL(@TOTAL_2020 ,0)
		,[CY 2023] = ISNULL(@TOTAL_2020 ,0)
		,[CY 2024] = ISNULL(@TOTAL_2020 ,0)
