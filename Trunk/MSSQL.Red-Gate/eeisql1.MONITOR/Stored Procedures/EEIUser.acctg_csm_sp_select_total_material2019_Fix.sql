...
create procedure [EEIUser].[acctg_csm_sp_select_total_material2019_Fix]
...
(select @base_part as [base_part],
		...
		/*
		ISNULL(jan_22,0) as [Jan 2022],
		ISNULL(feb_22,0) as [Feb 2022],
		ISNULL(mar_22,0) as [Mar 2022],
		ISNULL(apr_22,0) as [Apr 2022],
		ISNULL(may_22,0) as [May 2022],
		ISNULL(jun_22,0) as [Jun 2022],
		ISNULL(jul_22,0) as [Jul 2022],
		ISNULL(aug_22,0) as [Aug 2022],
		ISNULL(sep_22,0) as [Sep 2022],
		ISNULL(oct_22,0) as [Oct 2022],
		ISNULL(nov_22,0) as [Nov 2022],
		ISNULL(dec_22,0) as [Dec 2022],
		'' as Total_2022,
		*/
