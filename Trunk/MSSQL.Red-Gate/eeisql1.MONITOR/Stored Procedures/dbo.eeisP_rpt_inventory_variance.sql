...
from		gl_cost_transactions as glcostship
			left join gl_cost_transactions as glcostjc
				on glcostship.ledger_account = glcostjc.ledger_account
				and glcostship.document_id1 = glcostjc.document_id1
				and glcostship.document_reference1 = glcostjc.document_reference1
