...
GO
-- =============================================
-- Author:		Empire electronics Hn	
-- Create date: 4/18/2017	
-- Description:	Replicates the shipout analysis report withoun filters
-- =============================================
CREATE PROCEDURE [HN].[SP_MAT_Releases_Shipouts_AnalysisFull]
