...
CREATE PROCEDURE [FT].[ftsp_EMailAlert_AutoLivShipmentRequireOrderSave]
...
BEGIN	
		...
		,	@EmailHeader NVARCHAR(MAX) = 'AutoLiv Shipment Alert; Please Save Order Numbers In Monitor and Notify Shipping When Complete ' 
