...
create procedure [dbo].[usp_GetBlanketOrderReleases]
	@ActiveOrderNo int
...
--- <Body>
--drop table ##BlanketOrderReleases_Edit
...
where
	bor.ActiveOrderNo = @ActiveOrderNo
order by
	bor.ReleaseDT
,	bor.ReleaseNo
...
execute
	@ProcReturn = dbo.usp_GetBlanketOrderReleases
