...
CREATE procedure [EEIUser].[OBSacctg_csm_sp_select_total_planner_demand2018]
...
(case when (datepart(mm,shipper.date_shipped) = 12 and datepart(yyyy,shipper.date_shipped) = '20201') then sum(qty_packed) else 0 end) as dec_21
*/
