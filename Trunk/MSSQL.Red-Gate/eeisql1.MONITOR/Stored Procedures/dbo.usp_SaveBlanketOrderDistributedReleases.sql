...
CREATE procedure [dbo].[usp_SaveBlanketOrderDistributedReleases]
...
update
	dr
set
	RelPost = (select sum (QtyRelease) from @DistributedReleases where OrderNo = dr.OrderNo and ReleaseDT <= dr.ReleaseDT),
