...
CREATE procedure [EEIUser].[acctg_csm_sp_rollback_material_cost]
...
--- <Body>
-- Step 1: roll back Material Cost data one month in the detail table (which will fire a trigger to roll back the legacy table)
---<Delete>
...
-- Step 2: roll back Material Cost data one month in the header table
---<Delete>
