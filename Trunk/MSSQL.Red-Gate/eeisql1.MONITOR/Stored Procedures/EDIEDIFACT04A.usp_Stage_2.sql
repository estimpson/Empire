...
CREATE procedure [EDIEDIFACT04A].[usp_Stage_2]
...
execute
	...
	@objname = N'EDIEDIFACT04A.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningReleases'
...
insert
	EDIEDIFACT04A.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIEDIFACT04A.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIEDIFACT04A.ShipScheduleSupplemental'

insert
	EDIEDIFACT04A.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIEDIFACT04A.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIEDIFACT04A.ShipScheduleAccums'

insert
	EDIEDIFACT04A.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIEDIFACT04A.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIEDIFACT04A.ShipScheduleAuthAccums'

insert
	EDIEDIFACT04A.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIEDIFACT04A.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIEDIFACT04A.ShipSchedules'

insert
	EDIEDIFACT04A.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIEDIFACT04A.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIEDIFACT04A.PlanningHeaders'

insert
	EDIEDIFACT04A.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIEDIFACT04A.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIEDIFACT04A.PlanningSupplemental'

insert
	EDIEDIFACT04A.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIEDIFACT04A.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIEDIFACT04A.PlanningAccums'

insert
	EDIEDIFACT04A.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIEDIFACT04A.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIEDIFACT04A.PlanningAuthAccums'

insert
	EDIEDIFACT04A.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIEDIFACT04A.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDIEDIFACT04A.PlanningReleases'

insert
	EDIEDIFACT04A.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDIEDIFACT04A.StagingPlanningReleasesT sfr
...
truncate table
	EDIEDIFACT04A.StagingShipScheduleHeadersT
truncate table
	EDIEDIFACT04A.StagingShipScheduleSupplementalT
truncate table
	EDIEDIFACT04A.StagingShipScheduleAccumsT
truncate table
	EDIEDIFACT04A.StagingShipScheduleAuthAccumsT
truncate table
	EDIEDIFACT04A.StagingShipSchedulesT
truncate table
	EDIEDIFACT04A.StagingPlanningHeadersT
truncate table
	EDIEDIFACT04A.StagingPlanningSupplementalT
truncate table
	EDIEDIFACT04A.StagingPlanningAccumsT
truncate table
	EDIEDIFACT04A.StagingPlanningAuthAccumsT
truncate table
	EDIEDIFACT04A.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIEDIFACT04A.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIEDIFACT04A.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIEDIFACT04A.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIEDIFACT04A.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIEDIFACT04A.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIEDIFACT04A.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIEDIFACT04A.ShipSchedules sdrv
...
select
	*
from
	EDIEDIFACT04A.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIEDIFACT04A.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIEDIFACT04A.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIEDIFACT04A.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIEDIFACT04A.PlanningReleases sdrv
go
