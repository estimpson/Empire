...
CREATE procedure [EEIUser].[acctg_csm_sp_update_empire_adjustment2018] 
...
set		
		...
		*/
		...
		/*
		,[Jan 2021] = ISNULL(@Jan2020,0)
		,[Feb 2021] = ISNULL(@Feb2020,0)
		,[Mar 2021] = ISNULL(@Mar2020,0) 
		,[Apr 2021] = ISNULL(@Apr2020,0) 
		,[May 2021] = ISNULL(@May2020,0)  
		,[Jun 2021] = ISNULL(@Jun2020,0)
		,[Jul 2021] = ISNULL(@Jul2020,0)
		,[Aug 2021] = ISNULL(@Aug2020,0) 
		,[Sep 2021] = ISNULL(@Sep2020,0) 
		,[Oct 2021] = ISNULL(@Oct2020,0)
		,[Nov 2021] = ISNULL(@Nov2020,0) 
		,[Dec 2021] = ISNULL(@Dec2020,0)
		*/
...
set		[CY 2015] = (@jan2015+@feb2015+@mar2015+@apr2015+@may2015+@jun2015+@jul2015+@aug2015+@sep2015+@oct2015+@nov2015+@dec2015),
		...
		[Q1 2021] = (round(@total_2021/4,0)),
		[Q2 2021] = (round(@total_2021/4,0)),
		[Q3 2021] = (round(@total_2021/4,0)),
		[Q4 2021] = (round(@total_2021/4,0)),
