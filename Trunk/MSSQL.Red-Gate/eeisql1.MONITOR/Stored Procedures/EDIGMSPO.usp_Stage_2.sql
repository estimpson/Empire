...
CREATE procedure [EDIGMSPO].[usp_Stage_2]
...
set	@ProcName = user_name(objectproperty(@@procid, 'OwnerId')) + '.' + object_name(@@procid)  -- e.g. EDIGMSPO.usp_Test
--- </Error Handling>
...
execute
	...
	@objname = N'EDIGMSPO.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningReleases'
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.ShipScheduleHeaders'

insert
	EDIGMSPO.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIGMSPO.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.ShipScheduleSupplemental'

insert
	EDIGMSPO.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGMSPO.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.ShipScheduleAccums'

insert
	EDIGMSPO.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGMSPO.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.ShipScheduleAuthAccums'

insert
	EDIGMSPO.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGMSPO.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.ShipSchedules'

insert
	EDIGMSPO.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIGMSPO.StagingShipSchedulesT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.PlanningHeaders'

insert
	EDIGMSPO.PlanningHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIGMSPO.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.PlanningSupplemental'

insert
	EDIGMSPO.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGMSPO.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.PlanningAccums'

insert
	EDIGMSPO.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGMSPO.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.PlanningAuthAccums'

insert
	EDIGMSPO.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIGMSPO.StagingPlanningAuthAccumsT 
...
--- <Insert rows="*">
set	@TableName = 'EDIGMSPO.PlanningReleases'

insert
	EDIGMSPO.PlanningReleases
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[DateDT]
from
	EDIGMSPO.StagingPlanningReleasesT sfr
...
truncate table
	EDIGMSPO.StagingShipScheduleHeadersT
truncate table
	EDIGMSPO.StagingShipScheduleSupplementalT
truncate table
	EDIGMSPO.StagingShipScheduleAccumsT
truncate table
	EDIGMSPO.StagingShipScheduleAuthAccumsT
truncate table
	EDIGMSPO.StagingShipSchedulesT
truncate table
	EDIGMSPO.StagingPlanningHeadersT
truncate table
	EDIGMSPO.StagingPlanningSupplementalT
truncate table
	EDIGMSPO.StagingPlanningAccumsT
truncate table
	EDIGMSPO.StagingPlanningAuthAccumsT
truncate table
	EDIGMSPO.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIGMSPO.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIGMSPO.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIGMSPO.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIGMSPO.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIGMSPO.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIGMSPO.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIGMSPO.ShipSchedules sdrv
...
select
	*
from
	EDIGMSPO.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIGMSPO.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIGMSPO.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIGMSPO.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIGMSPO.PlanningReleases sdrv
go
