...
create procedure [EEIUser].[acctg_csm_sp_select_total_material2019]
...
/*
(YY.[Jan2022]*ZZ.[Jan 2022]) as [Jan 2022],
(YY.[Feb2022]*ZZ.[Feb 2022]) as [Feb 2022],
(YY.[Mar2022]*ZZ.[Mar 2022]) as [Mar 2022],
(YY.[Apr2022]*ZZ.[Apr 2022]) as [Apr 2022],
(YY.[May2022]*ZZ.[May 2022]) as [May 2022],
(YY.[Jun2022]*ZZ.[Jun 2022]) as [Jun 2022],
(YY.[Jul2022]*ZZ.[Jul 2022]) as [Jul 2022],
(YY.[Aug2022]*ZZ.[Aug 2022]) as [Aug 2022],
(YY.[Sep2022]*ZZ.[Sep 2022]) as [Sep 2022],
(YY.[Oct2022]*ZZ.[Oct 2022]) as [Oct 2022],
(YY.[Nov2022]*ZZ.[Nov 2022]) as [Nov 2022],
(YY.[Dec2022]*ZZ.[Dec 2022]) as [Dec 2022],
(YY.[Jan2022]*ZZ.[Jan 2022])+(YY.[Feb2022]*ZZ.[Feb 2022])+(YY.[Mar2022]*ZZ.[Mar 2022])+(YY.[Apr2022]*ZZ.[Apr 2022])+(YY.[May2022]*ZZ.[May 2022])+(YY.[Jun2022]*ZZ.[Jun 2022])+(YY.[Jul2022]*ZZ.[Jul 2022])+(YY.[Aug2022]*ZZ.[Aug 2022])+(YY.[Sep2022]*ZZ.[Sep 2022])+(YY.[Oct2022]*ZZ.[Oct 2022])+(YY.[Nov2022]*ZZ.[Nov 2022])+(YY.[Dec2022]*ZZ.[Dec 2022]) as [Total_2022],
*/
...
(YY.[Total_2026]*ZZ.[Total_2026]) as [Total_2026]
from
