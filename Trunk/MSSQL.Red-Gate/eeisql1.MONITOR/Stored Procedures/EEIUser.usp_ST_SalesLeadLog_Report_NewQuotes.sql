...
CREATE procedure [EEIUser].[usp_ST_SalesLeadLog_Report_NewQuotes]
	@NumberOfDays int
...
where
	qql.RowCreateDT >= dateadd(day, - @NumberOfDays, getdate())
group by
	qql.EEIPartNumber
)
...
--where
	--qql.QuoteStatus = 'COMPLETED' or qql.QuoteStatus = 'OPEN')
--- </Body>
