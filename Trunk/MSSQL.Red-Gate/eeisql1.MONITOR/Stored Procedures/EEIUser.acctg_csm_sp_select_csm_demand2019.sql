...
select	@base_part as [base_part],
		...
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Jan 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Jan 2021] end),0) as [jan 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Feb 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Feb 2021] end),0) as [feb 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Mar 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Mar 2021] end),0) as [mar 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Apr 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Apr 2021] end),0) as [apr 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[May 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[May 2021] end),0) as [may 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Jun 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Jun 2021] end),0) as [jun 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Jul 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Jul 2021] end),0) as [jul 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Aug 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Aug 2021] end),0) as [aug 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Sep 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Sep 2021] end),0) as [sep 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Oct 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Oct 2021] end),0) as [oct 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Nov 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Nov 2021] end),0) as [nov 2021], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Dec 2021],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Dec 2021] end),0) as [dec 2021], 
		...
		/*
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Jan 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Jan 2022] end),0) as [jan 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Feb 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Feb 2022] end),0) as [feb 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Mar 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Mar 2022] end),0) as [mar 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Apr 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Apr 2022] end),0) as [apr 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[May 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[May 2022] end),0) as [may 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Jun 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Jun 2022] end),0) as [jun 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Jul 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Jul 2022] end),0) as [jul 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Aug 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Aug 2022] end),0) as [aug 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Sep 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Sep 2022] end),0) as [sep 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Oct 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Oct 2022] end),0) as [oct 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Nov 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Nov 2022] end),0) as [nov 2022], 
		ISNULL((case when b.version in ('Empire Factor','Empire Adjustment') then ISNULL(b.[Dec 2022],0) else a.qty_per*a.take_rate*a.family_allocation*b.[Dec 2022] end),0) as [dec 2022], 
