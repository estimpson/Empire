...
CREATE procedure  [EEIUser].[acctg_inv_sp_reconciliation_daily_chooseable_BAMA]
(	@BegDate datetime,
	@EndDate datetime,
	@Account varchar (10),
	@PartType char(1))
...
from	#Acctg_InvChange Acctg_InvChange
	full join #Acctg_ActivityComparison Acctg_ActivityComparison on Acctg_InvChange.Part = Acctg_ActivityComparison.Part  where (acctg_invchange.part like 'NAL0040%' or acctg_invchange.part like '3157A%' or acctg_invchange.part like 'G930%' )
order by
	1, 2
