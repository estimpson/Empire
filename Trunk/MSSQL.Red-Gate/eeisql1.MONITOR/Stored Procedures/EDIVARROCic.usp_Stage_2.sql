...
Create procedure [EDIVARROCic].[usp_Stage_2]
...
execute
	...
	@objname = N'EDIVARROCic.StagingShipScheduleHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingShipScheduleSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingShipScheduleAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingShipScheduleAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingShipSchedules'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningHeaders'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningSupplemental'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningAuthAccums'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningReleases'
...
insert
	EDIVARROCic.ShipScheduleHeaders
(	RawDocumentGUID
,	DocumentImportDT
,	TradingPartner
,	DocType
...
,	sfh.DocumentDT
from
	EDIVARROCic.StagingShipScheduleHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIVARROCic.ShipScheduleSupplemental'

insert
	EDIVARROCic.ShipScheduleSupplemental
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVARROCic.StagingshipScheduleSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIVARROCic.ShipScheduleAccums'

insert
	EDIVARROCic.ShipScheduleAccums
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVARROCic.StagingshipScheduleAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIVARROCic.ShipScheduleAuthAccums'

insert
	EDIVARROCic.ShipScheduleAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVARROCic.StagingShipScheduleAuthAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIVARROCic.ShipSchedules'

insert
	EDIVARROCic.ShipSchedules
(		[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
select
      ...
      ,[ReleaseDT]
from
	EDIVARROCic.StagingShipSchedulesT sfr
...
,	sfh.DocumentDT
from
	EDIVARROCic.StagingPlanningHeadersT sfh
...
--- <Insert rows="*">
set	@TableName = 'EDIVARROCic.PlanningSupplemental'

insert
	EDIVARROCic.PlanningSupplemental
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVARROCic.StagingPlanningSupplementalT 
...
--- <Insert rows="*">
set	@TableName = 'EDIVARROCic.PlanningAccums'

insert
	EDIVARROCic.PlanningAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVARROCic.StagingPlanningAccumsT sfr
...
--- <Insert rows="*">
set	@TableName = 'EDIVARROCic.PlanningAuthAccums'

insert
	EDIVARROCic.PlanningAuthAccums
(	[RawDocumentGUID]
      ,[ReleaseNo]
      ,[ShipToCode]
      ,[ConsigneeCode]
...
from
	EDIVARROCic.StagingPlanningAuthAccumsT 
...
select
      ...
      ,[DateDT]
from
	EDIVARROCic.StagingPlanningReleasesT sfr
...
truncate table
	EDIVARROCic.StagingShipScheduleHeadersT
truncate table
	EDIVARROCic.StagingShipScheduleSupplementalT
truncate table
	EDIVARROCic.StagingShipScheduleAccumsT
truncate table
	EDIVARROCic.StagingShipScheduleAuthAccumsT
truncate table
	EDIVARROCic.StagingShipSchedulesT
truncate table
	EDIVARROCic.StagingPlanningHeadersT
truncate table
	EDIVARROCic.StagingPlanningSupplementalT
truncate table
	EDIVARROCic.StagingPlanningAccumsT
truncate table
	EDIVARROCic.StagingPlanningAuthAccumsT
truncate table
	EDIVARROCic.StagingPlanningReleasesT
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingShipScheduleHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingShipScheduleSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingShipScheduleAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingShipScheduleAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingShipSchedulesT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningHeadersT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningSupplementalT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningAuthAccumsT'
...
execute
	/*@ProcReturn = */dbo.sp_rename
	@objname = N'EDIVARROCic.StagingPlanningReleasesT'
...
execute
	@ProcReturn = EDIVARROCic.usp_Stage_2
	@TranDT = @TranDT out
...
select
	*
from
	EDIVARROCic.ShipScheduleHeaders sdhv
...
select
	*
from
	EDIVARROCic.ShipScheduleSupplemental sdrv

Select 'SSAccums'	
select
	*
from
	EDIVARROCic.ShipScheduleAccums sdrv

Select 'SSAuthAccums'
select
	*
from
	EDIVARROCic.ShipScheduleAuthAccums sdrv

Select 'SSchedules'
select
	*
from
	EDIVARROCic.ShipSchedules sdrv
...
select
	*
from
	EDIVARROCic.PlanningHeaders sdhv
Select 'PlanningSupplemental'
select
	*
from
	EDIVARROCic.PlanningSupplemental sdrv
Select 'PlanningAccums'
select
	*
from
	EDIVARROCic.PlanningAccums sdrv

Select 'PlanningAuthAccums'
select
	*
from
	EDIVARROCic.PlanningAuthAccums sdrv

Select 'PlanningReleases'
select
	*
from
	EDIVARROCic.PlanningReleases sdrv
go
