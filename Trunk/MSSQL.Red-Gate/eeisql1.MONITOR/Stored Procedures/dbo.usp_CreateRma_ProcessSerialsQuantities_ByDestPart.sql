...
CREATE procedure [dbo].[usp_CreateRma_ProcessSerialsQuantities_ByDestPart]
...
-- *****
-- For product_line PCB RMAs, the customer needs to be “EEI-PCB” and the destination “EEI-PCB”  
-- That is because this customer is assigned to company “08” and the default is assigned to company “12”
-- *****
declare
