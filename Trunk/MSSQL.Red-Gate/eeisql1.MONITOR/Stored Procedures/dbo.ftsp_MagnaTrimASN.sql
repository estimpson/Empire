...
CREATE procedure [dbo].[ftsp_MagnaTrimASN]  (@shipper int)
as
begin
--[dbo].[ftsp_MagnaTrimASN] 84766
...
declare
	...
	select
		...
		@REFPKValue = id,
		@REFCNValue = coalesce(nullif(pro_number,''), convert(varchar(25), bill_of_lading_number), Convert(varchar(25), id)),
