...
create procedure [EEIUser].[acctg_csm_sp_select_total_material_cost2019]
...
sum(ISNULL(jan_21,0)) as jan2021,
sum(ISNULL(feb_21,0)) as feb2021,
sum(ISNULL(mar_21,0)) as mar2021,
sum(ISNULL(apr_21,0)) as apr2021,
sum(ISNULL(may_21,0)) as may2021,
sum(ISNULL(jun_21,0)) as jun2021,
sum(ISNULL(jul_21,0)) as jul2021,
sum(ISNULL(aug_21,0)) as aug2021,
sum(ISNULL(sep_21,0)) as sep2021,
sum(ISNULL(oct_21,0)) as oct2021,
sum(ISNULL(nov_21,0)) as nov2021,
sum(ISNULL(dec_21,0)) as dec2021,
'' as Total_2021,

/*
sum(ISNULL(jan_22,0)) as jan2022,
sum(ISNULL(feb_22,0)) as feb2022,
sum(ISNULL(mar_22,0)) as mar2022,
sum(ISNULL(apr_22,0)) as apr2022,
sum(ISNULL(may_22,0)) as may2022,
sum(ISNULL(jun_22,0)) as jun2022,
sum(ISNULL(jul_22,0)) as jul2022,
sum(ISNULL(aug_22,0)) as aug2022,
sum(ISNULL(sep_22,0)) as sep2022,
sum(ISNULL(oct_22,0)) as oct2022,
sum(ISNULL(nov_22,0)) as nov2022,
sum(ISNULL(dec_22,0)) as dec2022,
'' as Total_2022,
*/
...
sum(ISNULL(dec_26,0)) as total_2026
