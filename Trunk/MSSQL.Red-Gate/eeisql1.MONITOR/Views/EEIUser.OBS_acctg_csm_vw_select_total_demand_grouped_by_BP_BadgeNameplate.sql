...
CREATE VIEW [EEIUser].[OBS_acctg_csm_vw_select_total_demand_grouped_by_BP_BadgeNameplate]
as
select
f.sales_parent,
f.base_part as base_part,
isNull(('"'+Badge+' '+NamePlate+'"'), 'No CSM Program Assigned') as BadgeNamePlate,
...
from 
(select 
a.base_part, a.empire_market_segment, NamePlate, badge, a.Empire_EOP, b.sales_parent,
...
group by sales_parent, base_part, isNull(('"'+Badge+' '+NamePlate+'"'), 'No CSM Program Assigned')
