...
CREATE VIEW [EEIUser].[OBS_acctg_csm_vw_select_total_demand_grouped_by_BP_program_EmpireAdjust]
as
select
...
group by base_part, empire_market_segment,isNull(program, 'No CSM Program Assigned')
