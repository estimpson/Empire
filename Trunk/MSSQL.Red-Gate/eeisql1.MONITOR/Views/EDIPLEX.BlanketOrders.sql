...
CREATE VIEW [EDIPLEX].[BlanketOrders]
AS
SELECT
	oh.model_year,
...
--,	ReferenceAccum =  'N'--  COALESCE(ReferenceAccum,'O')
--,	AdjustmentAccum = 'N' -- COALESCE(AdjustmentAccum,'C')
,	ShipScheduleReferenceAccum =  'N'--  COALESCE(ReferenceAccum,'O')
,	ShipScheduleAdjustmentAccum = 'N' -- COALESCE(AdjustmentAccum,'C')
,	PlanningReleaseAdjustmentAccum = COALESCE(AdjustmentAccum,'C') -- COALESCE(AdjustmentAccum,'C')
,	PlanningReleaseReferenceAccum = COALESCE(ReferenceAccum,'O')--  COALESCE(ReferenceAccum,'O')
