...
CREATE VIEW [EDILearmex].[BlanketOrders]
AS
SELECT
	oh.model_year,
...
,	CheckCustomerPOPlanning = CONVERT(BIT, CASE COALESCE(check_po, 'N') WHEN 'Y' THEN 1 ELSE 1 END)
...
WHERE
 ...
 es.trading_partner_code = 'LEARMEXICO'
