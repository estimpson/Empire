...
CREATE VIEW [EEIUser].[OBS_acctg_csm_vw_select_total_demand_grouped_by_BP_AssemblyPlant]
as
select
f.sales_parent,
...
group by sales_parent, base_part, isNull(('"'+Assembly_plant+'"'), 'No CSM Program Assigned')
