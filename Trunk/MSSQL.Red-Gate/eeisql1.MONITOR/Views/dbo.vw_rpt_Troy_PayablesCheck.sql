...
FROM	 Empower.dbo.vr_ap_check_proof vr_ap_check_proof 
left join	 Empower.dbo.document_approval_items document_approval_items on document_approval_items.document_id1 = vr_ap_check_proof.document_id1 
