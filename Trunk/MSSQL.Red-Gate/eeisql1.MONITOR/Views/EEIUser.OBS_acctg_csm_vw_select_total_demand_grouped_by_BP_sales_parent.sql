...
CREATE VIEW [EEIUser].[OBS_acctg_csm_vw_select_total_demand_grouped_by_BP_sales_parent]
as
select
f.sales_parent,
f.base_part as base_part,
isNull(('"'+sales_parent+'"'), 'No CSM Program Assigned') as SalesParent,
...
group by sales_parent, base_part, isNull(('"'+sales_parent+'"'), 'No CSM Program Assigned')
