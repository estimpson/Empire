...
GO
ALTER TABLE [EEIUser].[csmadj] ADD CONSTRAINT [ACCTG_CSM_NAIHS_CSMADJ_PK] PRIMARY KEY CLUSTERED  ([Release_ID], [Version], [Mnemonic-Vehicle/Plant]) ON [PRIMARY]
GO
