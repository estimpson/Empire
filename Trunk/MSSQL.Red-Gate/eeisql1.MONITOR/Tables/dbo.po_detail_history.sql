...
[cum_invoiced_quantity] [numeric] (18, 6) NULL,
[cum_invoiced_amount] [numeric] (18, 6) NULL,
[alternate_price] [numeric] (20, 6) NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[po_detail_history] ADD CONSTRAINT [FK__po_detail__po_nu__4D6A6A69] FOREIGN KEY ([po_number]) REFERENCES [dbo].[po_header] ([po_number])
GO
