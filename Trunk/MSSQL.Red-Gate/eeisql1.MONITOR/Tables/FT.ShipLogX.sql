CREATE TABLE [FT].[ShipLogX]
(
[RowStatus] [int] NULL CONSTRAINT [DF__ShipLogX__RowSta__4A78EF25] DEFAULT ((100)),
[Serial] [int] NOT NULL,
...
GO
ALTER TABLE [FT].[ShipLogX] ADD CONSTRAINT [PK__ShipLogX__4984CAEC] PRIMARY KEY NONCLUSTERED  ([Serial], [Shipper]) ON [PRIMARY]
GO
