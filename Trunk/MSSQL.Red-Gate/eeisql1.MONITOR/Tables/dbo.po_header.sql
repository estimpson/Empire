...
[ppap] [varchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[idms] [varchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[cum_received_qty] [numeric] (20, 6) NULL,
[next_seqno] [int] NULL,
[ship_from] [varchar] (15) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
...
GO
CREATE NONCLUSTERED INDEX [idx_po_header_FT_1] ON [dbo].[po_header] ([blanket_part]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_po_header_FT_2] ON [dbo].[po_header] ([status], [release_control], [po_number]) ON [PRIMARY]
GO
GRANT SELECT ON  [dbo].[po_header] TO [APPUser]
GO
