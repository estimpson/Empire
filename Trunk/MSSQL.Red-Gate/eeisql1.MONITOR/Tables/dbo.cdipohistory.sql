...
[row_id] [int] NULL,
[release_no] [int] NULL,
[raccuracy] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__cdipohist__raccu__595B4002] DEFAULT ('A'),
[premium_freight] [char] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__cdipohist__premi__5A4F643B] DEFAULT ('N'),
[premium_amount] [decimal] (20, 2) NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[cdipohistory] ADD CONSTRAINT [PK__cdipohistory__3069A6C8] PRIMARY KEY CLUSTERED  ([id]) ON [PRIMARY]
GO
