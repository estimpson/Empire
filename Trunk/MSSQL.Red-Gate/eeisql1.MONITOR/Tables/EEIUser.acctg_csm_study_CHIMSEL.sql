CREATE TABLE [EEIUser].[acctg_csm_study_CHIMSEL]
(
...
GO
ALTER TABLE [EEIUser].[acctg_csm_study_CHIMSEL] ADD CONSTRAINT [PK_acctg_csm_CHIMSEL] PRIMARY KEY CLUSTERED  ([forecast_id], [version], [mnemonic], [type], [supplier]) ON [PRIMARY]
GO
