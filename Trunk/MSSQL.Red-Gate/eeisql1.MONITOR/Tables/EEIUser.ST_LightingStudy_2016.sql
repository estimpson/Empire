CREATE TABLE [EEIUser].[ST_LightingStudy_2016]
(
...
GO
ALTER TABLE [EEIUser].[ST_LightingStudy_2016] ADD CONSTRAINT [PK_ST_LightingStudy2_2016] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
