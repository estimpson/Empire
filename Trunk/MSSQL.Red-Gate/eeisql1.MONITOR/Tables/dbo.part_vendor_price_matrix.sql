...
GO
ALTER TABLE [dbo].[part_vendor_price_matrix] ADD CONSTRAINT [PK__part_vendor_pric__6AA5C795] PRIMARY KEY CLUSTERED  ([part], [vendor], [break_qty]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[part_vendor_price_matrix] ADD CONSTRAINT [FK__part_vendor_pric__5CACADF9] FOREIGN KEY ([part], [vendor]) REFERENCES [dbo].[part_vendor] ([part], [vendor])
GO
