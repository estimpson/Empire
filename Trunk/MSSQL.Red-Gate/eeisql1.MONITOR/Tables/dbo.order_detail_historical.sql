CREATE TABLE [dbo].[order_detail_historical]
(
...
GO
ALTER TABLE [dbo].[order_detail_historical] ADD CONSTRAINT [PK_order_detail_historical] PRIMARY KEY CLUSTERED  ([date_stamp], [id]) ON [PRIMARY]
GO
