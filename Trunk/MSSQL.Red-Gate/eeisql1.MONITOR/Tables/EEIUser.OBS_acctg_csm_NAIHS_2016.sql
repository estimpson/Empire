CREATE TABLE [EEIUser].[OBS_acctg_csm_NAIHS_2016]
(
...
GO
ALTER TABLE [EEIUser].[OBS_acctg_csm_NAIHS_2016] ADD CONSTRAINT [PK__acctg_cs__D835C0A51FF70668] PRIMARY KEY CLUSTERED  ([Release_ID], [Version], [Mnemonic-Vehicle/Plant]) ON [PRIMARY]
GO
