CREATE TABLE [EEIUser].[WP_UpdateCsmDemand_TakeRate_History]
(
...
[QtyPerNew] [decimal] (20, 6) NULL,
[FamilyAllocation] [decimal] (20, 6) NULL,
[FamilyAllocationNew] [decimal] (20, 6) NULL,
...
GO
ALTER TABLE [EEIUser].[WP_UpdateCsmDemand_TakeRate_History] ADD CONSTRAINT [PK__WP_Updat__3214EC276C2B1964] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
