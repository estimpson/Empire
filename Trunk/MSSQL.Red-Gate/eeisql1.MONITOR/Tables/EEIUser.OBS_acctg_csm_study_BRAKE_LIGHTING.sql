CREATE TABLE [EEIUser].[OBS_acctg_csm_study_BRAKE_LIGHTING]
(
...
GO
ALTER TABLE [EEIUser].[OBS_acctg_csm_study_BRAKE_LIGHTING] ADD CONSTRAINT [PK_acctg_csm_FORWARD_LIGHTING] PRIMARY KEY CLUSTERED  ([FORECAST_ID], [VERSION], [MNEMONIC], [SUPPLIER]) ON [PRIMARY]
GO
