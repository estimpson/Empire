...
[RowCreateDT] [datetime] NULL CONSTRAINT [DF__ST_Lighti__RowCr__16C56782] DEFAULT (getdate()),
[RowCreateUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ST_Lighti__RowCr__17B98BBB] DEFAULT (suser_name()),
[RowModifiedDT] [datetime] NULL CONSTRAINT [DF__ST_Lighti__RowMo__18ADAFF4] DEFAULT (getdate()),
[RowModifiedUser] [sys].[sysname] NOT NULL CONSTRAINT [DF__ST_Lighti__RowMo__19A1D42D] DEFAULT (suser_name())
) ON [PRIMARY]
GO
...
*/
GO
ALTER TABLE [EEIUser].[ST_LightingStudy_TailLampNA] ADD CONSTRAINT [PK__ST_Light__FFEE745114DD1F10] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
