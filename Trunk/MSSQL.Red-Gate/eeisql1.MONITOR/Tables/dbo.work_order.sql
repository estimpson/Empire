...
GO
ALTER TABLE [dbo].[work_order] ADD CONSTRAINT [PK__work_order__4FF1D159] PRIMARY KEY CLUSTERED  ([work_order]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [machine] ON [dbo].[work_order] ([machine_no]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[work_order] ADD CONSTRAINT [FK__work_orde__proce__5046D714] FOREIGN KEY ([process_id]) REFERENCES [dbo].[process] ([id])
GO
