CREATE TABLE [dbo].[dbo.delfor_cytd_gmspo_fxDelete]
(
...
[cytd_start_date] [varchar] (35) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[cytd_qty_shipped] [varchar] (35) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
