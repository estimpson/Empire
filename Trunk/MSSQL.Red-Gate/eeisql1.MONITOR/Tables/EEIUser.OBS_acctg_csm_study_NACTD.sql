CREATE TABLE [EEIUser].[OBS_acctg_csm_study_NACTD]
(
...
GO
ALTER TABLE [EEIUser].[OBS_acctg_csm_study_NACTD] ADD CONSTRAINT [PK_acctg_csm_NACTD] PRIMARY KEY CLUSTERED  ([release_id], [Mnemonic]) ON [PRIMARY]
GO
