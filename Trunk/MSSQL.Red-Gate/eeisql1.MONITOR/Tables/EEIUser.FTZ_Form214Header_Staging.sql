CREATE TABLE [EEIUser].[FTZ_Form214Header_Staging]
(
...
GO
ALTER TABLE [EEIUser].[FTZ_Form214Header_Staging] ADD CONSTRAINT [PK_FTZ_Form214Header_Staging] PRIMARY KEY CLUSTERED  ([Box6_ZoneAdmissionNo]) ON [PRIMARY]
GO
