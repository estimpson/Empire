...
GO
ALTER TABLE [EEIUser].[acctg_csm_study_FORWARD_LIGHTING] ADD CONSTRAINT [PK_acctg_csm_FORWARD_LIGHTING_1] PRIMARY KEY CLUSTERED  ([FORECAST_ID], [VERSION], [MNEMONIC], [COMPONENT], [TYPE], [SUPPLIER]) ON [PRIMARY]
GO
