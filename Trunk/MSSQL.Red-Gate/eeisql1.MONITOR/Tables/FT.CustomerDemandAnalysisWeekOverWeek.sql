CREATE TABLE [FT].[CustomerDemandAnalysisWeekOverWeek]
(
...
GO
CREATE CLUSTERED INDEX [IX_CustomerDemandAnalysisWeekOverWeek] ON [FT].[CustomerDemandAnalysisWeekOverWeek] ([BasePart], [Customer]) ON [PRIMARY]
GO
