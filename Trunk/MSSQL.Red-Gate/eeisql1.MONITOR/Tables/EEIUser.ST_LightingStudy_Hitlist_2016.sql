CREATE TABLE [EEIUser].[ST_LightingStudy_Hitlist_2016]
(
...
GO
ALTER TABLE [EEIUser].[ST_LightingStudy_Hitlist_2016] ADD CONSTRAINT [PK__ST_FASTT__3214EC276105AFB6] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
