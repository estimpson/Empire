CREATE TABLE [EEIUser].[OBS_acctg_csm_selling_prices]
(
...
GO
ALTER TABLE [EEIUser].[OBS_acctg_csm_selling_prices] ADD CONSTRAINT [PK_acctg_csm_selling_prices] PRIMARY KEY CLUSTERED  ([FORECAST_ID], [VERSION], [BASE_PART], [YEAR], [PERIOD]) ON [PRIMARY]
GO
