CREATE TABLE [EEIUser].[BasePartCloseouts]
(
...
GO
ALTER TABLE [EEIUser].[BasePartCloseouts] ADD CONSTRAINT [PK__BasePart__FFEE7451314C1330] PRIMARY KEY CLUSTERED  ([RowID]) ON [PRIMARY]
GO
