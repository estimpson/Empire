...
GO
ALTER TABLE [EEIUser].[acctg_csm_base_part_mnemonic] ADD CONSTRAINT [PK_acctg_csm_base_part_mnemonic] PRIMARY KEY CLUSTERED  ([FORECAST_ID], [MNEMONIC], [BASE_PART]) ON [PRIMARY]
GO
