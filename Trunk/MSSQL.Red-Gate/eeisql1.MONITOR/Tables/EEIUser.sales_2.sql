...
[forecast_year] [char] (4) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[forecast_period] [char] (2) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [EEIUser].[sales_2] ADD CONSTRAINT [PK_sales_2] PRIMARY KEY CLUSTERED  ([base_part]) ON [PRIMARY]
GO
