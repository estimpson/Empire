...
GO
ALTER TABLE [dbo].[workorder_header_history] ADD CONSTRAINT [PK__workorder_header__4E0988E7] PRIMARY KEY CLUSTERED  ([work_order], [machine_no], [sequence]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[workorder_header_history] ADD CONSTRAINT [FK__workorder__proce__4F52B2DB] FOREIGN KEY ([process_id]) REFERENCES [dbo].[process] ([id])
GO
