...
[empower_flag] [char] (8) COLLATE SQL_Latin1_General_CP1_CI_AS NULL
) ON [PRIMARY]
GO
...
GO
ALTER TABLE [dbo].[vendor] ADD CONSTRAINT [PK__vendor__26DAAD2D] PRIMARY KEY CLUSTERED  ([code]) ON [PRIMARY]
GO
