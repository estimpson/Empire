CREATE TABLE [EEIUser].[OBS_acctg_csm_NAIHS]
(
...
GO
ALTER TABLE [EEIUser].[OBS_acctg_csm_NAIHS] ADD CONSTRAINT [PK__acctg_cs__D835C0A518D99DFC] PRIMARY KEY CLUSTERED  ([Release_ID], [Version], [Mnemonic-Vehicle/Plant]) ON [PRIMARY]
GO
