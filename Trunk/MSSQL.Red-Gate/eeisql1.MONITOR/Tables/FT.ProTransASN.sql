...
GO
ALTER TABLE [FT].[ProTransASN] ADD CONSTRAINT [PK__ProTransASN__043B7C66] PRIMARY KEY CLUSTERED  ([ID]) ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX [idx_ProTransASN_1] ON [FT].[ProTransASN] ([Status]) ON [PRIMARY]
GO
