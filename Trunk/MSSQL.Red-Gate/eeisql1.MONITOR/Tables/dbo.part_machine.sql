...
[overlap_type] [varchar] (1) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_part_machine_2] ON [dbo].[part_machine] ([sequence], [machine], [part]) ON [PRIMARY]
GO
CREATE STATISTICS [_dta_stat_946102411_1_3] ON [dbo].[part_machine] ([part], [sequence], [machine])
GO
GRANT SELECT ON  [dbo].[part_machine] TO [APPUser]
GO
