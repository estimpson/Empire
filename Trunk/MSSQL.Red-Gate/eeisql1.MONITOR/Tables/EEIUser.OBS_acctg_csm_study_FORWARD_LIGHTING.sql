CREATE TABLE [EEIUser].[OBS_acctg_csm_study_FORWARD_LIGHTING]
(
...
[ADAPTIVE] [varchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
ALTER TABLE [EEIUser].[OBS_acctg_csm_study_FORWARD_LIGHTING] ADD CONSTRAINT [PK_acctg_csm_FORWARD_LIGHTING_1] PRIMARY KEY CLUSTERED  ([FORECAST_ID], [VERSION], [MNEMONIC], [COMPONENT], [TYPE], [SUPPLIER]) ON [PRIMARY]
GO
