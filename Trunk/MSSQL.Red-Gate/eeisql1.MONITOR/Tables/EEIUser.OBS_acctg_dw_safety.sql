CREATE TABLE [EEIUser].[OBS_acctg_dw_safety]
(
...
GO
ALTER TABLE [EEIUser].[OBS_acctg_dw_safety] ADD CONSTRAINT [acctg_dw_safety_pk] PRIMARY KEY CLUSTERED  ([Release_ID], [Version], [Mnemonic-Vehicle/Plant]) ON [PRIMARY]
GO
