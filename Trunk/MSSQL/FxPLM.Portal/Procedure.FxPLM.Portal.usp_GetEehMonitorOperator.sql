...
/*
Create Procedure.FxPLM.Portal.usp_GetEehMonitorOperator.sql
*/

use FxPLM
go

if	objectproperty(object_id('Portal.usp_GetEehMonitorOperator'), 'IsProcedure') = 1 begin
	drop procedure Portal.usp_GetEehMonitorOperator
end
go

create procedure Portal.usp_GetEehMonitorOperator
	@Value varchar(max)
...
execute
	@ProcReturn = Portal.usp_GetEehMonitorOperator
	@Value = @Value
,	@TranDT = @TranDT out
,	@Result = @ProcResult out
