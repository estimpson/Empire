...
/*
Create View.MONITOR.dbo.CreateRma_RTV_PackingSlip.sql
*/

use MONITOR
go

--drop table dbo.CreateRma_RTV_PackingSlip
if objectproperty(object_id('dbo.CreateRma_RTV_PackingSlip'), 'IsView') = 1
	begin
		drop view dbo.CreateRma_RTV_PackingSlip
	end
go
...
select
	*
from
	dbo.CreateRma_RTV_PackingSlip crrps
where
	crrps.RTVShipperID = 103133