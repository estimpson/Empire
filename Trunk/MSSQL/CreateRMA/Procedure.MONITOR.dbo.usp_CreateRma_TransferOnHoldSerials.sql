...
/*
Create Procedure.MONITOR.dbo.usp_CreateRma_TransferOnHoldSerials.sql
*/

use MONITOR
go

if	objectproperty(object_id('dbo.usp_CreateRma_TransferOnHoldSerials'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_CreateRma_TransferOnHoldSerials
end
go
