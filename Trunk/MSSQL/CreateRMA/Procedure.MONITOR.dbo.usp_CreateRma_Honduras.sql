...
/*
Create Procedure.MONITOR.dbo.usp_CreateRma_Honduras.sql
*/

use MONITOR
go

if	objectproperty(object_id('dbo.usp_CreateRma_Honduras'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_CreateRma_Honduras
end
go
