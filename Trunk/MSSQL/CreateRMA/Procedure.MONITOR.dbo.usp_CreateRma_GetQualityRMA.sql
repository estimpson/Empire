...
/*
Create Procedure.MONITOR.dbo.usp_CreateRma_GetQualityRMA.sql
*/

use MONITOR
go

if	objectproperty(object_id('dbo.usp_CreateRma_GetQualityRMA'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_CreateRma_GetQualityRMA
end
go
...
declare
	@RMANumber varchar(50) = 'RMA16-286'

exec dbo.usp_CreateRma_GetQualityRMA
	@RMANumber = @RMANumber
go
