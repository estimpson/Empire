...
/*
Create Procedure.MONITOR.dbo.usp_StageShipoutRtv_UpdatePo.sql
*/

use MONITOR
go

if	objectproperty(object_id('dbo.usp_StageShipoutRtv_UpdatePo'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_StageShipoutRtv_UpdatePo
end
go
