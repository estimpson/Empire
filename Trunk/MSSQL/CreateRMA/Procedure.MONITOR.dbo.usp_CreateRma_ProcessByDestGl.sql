...
/*
Create Procedure.MONITOR.dbo.usp_CreateRma_ProcessByDestGl.sql
*/

use MONITOR
go

if	objectproperty(object_id('dbo.usp_CreateRma_ProcessByDestGl'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_CreateRma_ProcessByDestGl
end
go
