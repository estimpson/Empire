...
/*
Create ScalarFunction.MONITOR.EDI_XML_Autosystems_ASN.udf_Root.sql
*/

use MONITOR
go

if	objectproperty(object_id('EDI_XML_Autosystems_ASN.udf_Root'), 'IsScalarFunction') = 1 begin
	drop function EDI_XML_Autosystems_ASN.udf_Root
end
go
			...
			(	select
					(	select
						...
						,	(	select
								...
								,	EDI_XML_Autosystems_ASN.SEG_PRF(al.CustomerPO, '200001' + right('0'+convert(varchar, al.RowNumber),2))
...
select
	EDI_XML_Autosystems_ASN.udf_Root(99622, '00', 0)
