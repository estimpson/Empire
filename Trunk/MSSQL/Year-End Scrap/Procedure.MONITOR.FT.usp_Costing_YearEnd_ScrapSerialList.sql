...
/*
Create Procedure.MONITOR.FT.usp_Costing_YearEnd_ScrapSerialList.sql
*/

use MONITOR
go

if	objectproperty(object_id('FT.usp_Costing_YearEnd_ScrapSerialList'), 'IsProcedure') = 1 begin
	drop procedure FT.usp_Costing_YearEnd_ScrapSerialList
end
go
...
execute
	FT.usp_Costing_YearEnd_ScrapSerialList
	    @Operator = 'EES'
	,   @SerialCSVFile_ServerPath = 'C:\Temp\SerialList.CSV'
	,   @EffectiveDT = '2014-04-04 18:18:12'
	,   @Mode = 0
go
