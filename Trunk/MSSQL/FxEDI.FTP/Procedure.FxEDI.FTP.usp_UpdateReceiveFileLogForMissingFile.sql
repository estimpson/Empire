...
/*
Create Procedure.FxEDI.FTP.usp_UpdateReceiveFileLogForMissingFile.sql
*/

use FxEDI
go

if	objectproperty(object_id('FTP.usp_UpdateReceiveFileLogForMissingFile'), 'IsProcedure') = 1 begin
	drop procedure FTP.usp_UpdateReceiveFileLogForMissingFile
end
go

create procedure FTP.usp_UpdateReceiveFileLogForMissingFile
	@MissingFileRowID int
...
execute
	@ProcReturn = FTP.usp_UpdateReceiveFileLogForMissingFile
	@Param1 = @Param1
,	@TranDT = @TranDT out
