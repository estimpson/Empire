...
/*
Create Procedure.FxEDI.FTP.usp_UpdateReceiveFileLogForUnavailableFile.sql
*/

use FxEDI
go

if	objectproperty(object_id('FTP.usp_UpdateReceiveFileLogForUnavailableFile'), 'IsProcedure') = 1 begin
	drop procedure FTP.usp_UpdateReceiveFileLogForUnavailableFile
end
go
...
exec FTP.usp_UpdateReceiveFileLogForUnavailableFile
	@UnavailableFileRowID = 23