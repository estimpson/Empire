...
/*
Create View.FxEDI.FTP.TaskActivityMonitor.sql
*/

use FxEDI
go

--drop table FTP.TaskActivityMonitor
if	objectproperty(object_id('FTP.TaskActivityMonitor'), 'IsView') = 1 begin
	drop view FTP.TaskActivityMonitor
end
go
