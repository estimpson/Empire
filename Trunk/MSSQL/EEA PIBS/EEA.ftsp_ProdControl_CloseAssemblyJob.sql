...
if	objectproperty(object_id('EEA.ftsp_ProdControl_CloseAssemblyJob'), 'IsProcedure') = 1 begin
	drop procedure EEA.ftsp_ProdControl_CloseAssemblyJob
end
go
