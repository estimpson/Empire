...
if	objectproperty(object_id('EEA.IntercompanyAuditTrail'), 'IsView') = 1 begin
	drop view EEA.IntercompanyAuditTrail
end
go
...
create trigger trIntercompanyAuditTrail_iud on EEA.IntercompanyAuditTrail instead of insert, update, delete
as
/*
Inserts:
...
select
	ID = -1
,	Serial = 772608
,	TranDT = '2011-03-15 17:06:38.687'
,	Part = 'T938 828-01'
,	PartIntercompany = ''
,	Operator = 'ES'
,	QtyTransfer = 300
...
select
	*
from
	EEA.IntercompanyAuditTrail iat
...
where
	serial = 772608
	and
		date_stamp = '2011-03-15 17:06:38.687'
go
