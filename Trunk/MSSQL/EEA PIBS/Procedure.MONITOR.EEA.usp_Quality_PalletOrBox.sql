...
/*
Create Procedure.MONITOR.EEA.usp_Quality_PalletOrBox.sql
*/

use MONITOR
go

if	objectproperty(object_id('EEA.usp_Quality_PalletOrBox'), 'IsProcedure') = 1 begin
	drop procedure EEA.usp_Quality_PalletOrBox
end
go
...
set @newLocation = case when @NewStatus = 'H' then 'ALA-CERTIF' when @NewStatus = 'A' then 'ALA-WRHQUE' end
