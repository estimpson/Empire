...
/*
Create Procedure.MONITOR.FT.usp_InvControl_CombinePallet.sql
*/

use MONITOR
go

if	objectproperty(object_id('FT.usp_InvControl_CombinePallet'), 'IsProcedure') = 1 begin
	drop procedure FT.usp_InvControl_CombinePallet
end
go
