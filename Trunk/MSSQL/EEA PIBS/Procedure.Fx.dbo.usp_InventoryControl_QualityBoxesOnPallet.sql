...
/*
Create Procedure.Fx.dbo.usp_InventoryControl_QualityBoxesOnPallet.sql
*/

--use Fx
--go

if	objectproperty(object_id('dbo.usp_InventoryControl_QualityBoxesOnPallet'), 'IsProcedure') = 1 begin
	drop procedure dbo.usp_InventoryControl_QualityBoxesOnPallet
end
go
