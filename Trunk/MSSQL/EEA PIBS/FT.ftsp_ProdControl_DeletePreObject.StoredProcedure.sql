...
if	objectproperty(object_id('FT.ftsp_ProdControl_DeletePreObject'), 'IsProcedure') = 1 begin
	drop procedure FT.ftsp_ProdControl_DeletePreObject
end
go
...
where
	PreObjectHistory.Serial = @PreObjectSerial
