...
/*
Create function TableFunction.MONITOR.EEA.fn_GetPartFIFO.sql
*/

--use MONITOR
--go

if	objectproperty(object_id('EEA.fn_GetPartFIFO'), 'IsTableFunction') = 1 begin
	drop function EEA.fn_GetPartFIFO
end
go

create function EEA.fn_GetPartFIFO
(	@Part varchar(25)
,	@Status varchar(1) = 'A'
...
select
	*
from
	EEA.fn_GetPartFIFO('K938 828-06', 'A', null, null, 'N')
order by
	FirstDT
go
...
select
	*
from
	EEA.fn_GetPartFIFO('NAL0159-DSA06', 'A', null, null, 'N')
order by
	FirstDT
go
