...
/*
Create function TableFunction.MONITOR.EEA.fn_ProgramShippingRequirements_NewIntransit.sql
*/

use MONITOR
go

if	objectproperty(object_id('EEA.fn_ProgramShippingRequirements_NewIntransit'), 'IsTableFunction') = 1 begin
	drop function EEA.fn_ProgramShippingRequirements_NewIntransit
end
go
...
select
	*
from
	EEA.fn_ProgramShippingRequirements_NewIntransit() fpsrni
order by
	ProgramCode
,	DueDT
go
