...
/*
Create procedure MONITOR.FT.ftsp_ProdControl_DeleteObsoletePreObjects
*/

use MONITOR
go

if	objectproperty(object_id('FT.ftsp_ProdControl_DeleteObsoletePreObjects'), 'IsProcedure') = 1 begin
	drop procedure FT.ftsp_ProdControl_DeleteObsoletePreObjects
end
go
