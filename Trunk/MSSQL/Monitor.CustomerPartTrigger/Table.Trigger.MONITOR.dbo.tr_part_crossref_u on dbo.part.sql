/*
Create trigger Table.Trigger.MONITOR.dbo.tr_part_crossref_u on dbo.part
*/

use MONITOR
go

if	objectproperty(object_id('dbo.tr_part_crossref_u'), 'IsTrigger') = 1 begin
	drop trigger dbo.tr_part_crossref_u
end
go
...
alter table dbo.part disable trigger tr_part_crossref_u
go
