...
/*
Create Procedure.Monitor.FT.usp_VendorPastDueAnalysis.sql
*/

use Monitor
go

if	objectproperty(object_id('FT.usp_VendorPastDueAnalysis'), 'IsProcedure') = 1 begin
	drop procedure FT.usp_VendorPastDueAnalysis
end
go
