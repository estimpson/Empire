...
/****** Object:  StoredProcedure [EEIUser].[usp_QT_DeleteQuoteCSM]    Script Date: 03/04/2013 11:16:59 ******/
SET ANSI_NULLS ON
GO
...
CREATE procedure [EEIUser].[usp_QT_DeleteQuoteCSM]
...
where
	...
	and qcsm.CSM_Mnemonic = @CSM_Mnemonic
...
execute
	@ProcReturn = EEIUser.usp_QT_GetQuoteCSM
	@Param1 = @Param1
,	@TranDT = @TranDT out
