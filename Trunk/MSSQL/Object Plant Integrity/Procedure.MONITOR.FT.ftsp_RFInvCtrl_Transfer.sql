...
/*
Create Procedure.MONITOR.FT.ftsp_RFInvCtrl_Transfer.sql
*/

use MONITOR
go

if	objectproperty(object_id('FT.ftsp_RFInvCtrl_Transfer'), 'IsProcedure') = 1 begin
	drop procedure FT.ftsp_RFInvCtrl_Transfer
end
go
