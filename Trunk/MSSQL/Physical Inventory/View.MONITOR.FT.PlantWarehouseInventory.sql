...
/*
Create View.MONITOR.FT.PlantWarehouseInventory.sql
*/

--use MONITOR
--go

--drop table FT.PlantWarehouseInventory
if	objectproperty(object_id('FT.PlantWarehouseInventory'), 'IsView') = 1 begin
	drop view FT.PlantWarehouseInventory
end
go
...
,	Part = o.part
,	Quantity = o.quantity
,	Type = case when substring(o.location, 7, 4) = 'FIS' then 'PHYS' else 'LOST' end
,	Operator = o.operator
from
	dbo.object o
	join dbo.location l
...
,	Address = 'EE' + substring(o.location, 3, 8)
,	LocationCode = o.location
,	Serial = o.serial
,	Part = o.part
,	Quantity = o.quantity
,	Type = case left(o.location, 1) when 'P' then 'PHYS' when 'L' then 'LOST' end
,	Operator = o.operator
from
	dbo.object o
