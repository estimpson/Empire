...
/*
Create Procedure.MONITOR.FT.usp_PhysInv_ScanSerial.sql
*/

--use MONITOR
--go

if	objectproperty(object_id('FT.usp_PhysInv_ScanSerial'), 'IsProcedure') = 1 begin
	drop procedure FT.usp_PhysInv_ScanSerial
end
go
