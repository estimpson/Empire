...
/*
Create ScalarFunction.EEH.EDI_XML_ACCUM_830.Get830_NoPrice.sql
*/

use EEH
go

if	objectproperty(object_id('EDI_XML_ACCUM_830.Get830_NoPrice'), 'IsScalarFunction') = 1 begin
	drop function EDI_XML_ACCUM_830.Get830_NoPrice
end
go

create function EDI_XML_ACCUM_830.Get830_NoPrice
...
select
	EDI_XML_ACCUM_830.Get830_NoPrice('PSG', '52721,48236', '05', 1)