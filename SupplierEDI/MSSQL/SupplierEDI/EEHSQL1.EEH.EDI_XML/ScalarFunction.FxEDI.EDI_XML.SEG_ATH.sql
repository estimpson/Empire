...
/*
Create ScalarFunction.FxEDI.EDI_XML.SEG_ATH.sql
*/

use FxEDI
go

if	objectproperty(object_id('EDI_XML.SEG_ATH'), 'IsScalarFunction') = 1 begin
	drop function EDI_XML.SEG_ATH
end
go
...
select
	EDI_XML.SEG_ATH('003060', 'FI', '2015-12-12', '1742399', default, '20101027')
