...
/*
Create ScalarFunction.FxEDI.EDI_XML.SEG_FST.sql
*/

use FxEDI
go

if	objectproperty(object_id('EDI_XML.SEG_FST'), 'IsScalarFunction') = 1 begin
	drop function EDI_XML.SEG_FST
end
go
...
select
	EDI_XML.SEG_FST('004010', 180, 'D', 'D', '2015-12-03', default, default, default, default, default, default)
