...
/*
Create Procedure.FxEDI.FTP.usp_SendSupplierEDI_TestMailBox.sql
*/

use FxEDI
go

if	objectproperty(object_id('FTP.usp_SendSupplierEDI_TestMailBox'), 'IsProcedure') = 1 begin
	drop procedure FTP.usp_SendSupplierEDI_TestMailBox
end
go

create procedure FTP.usp_SendSupplierEDI_TestMailBox
	@SendFileFromFolderRoot sysname = '\RawEDIData\SupplierEDI_TestMailBox\OutBound'
...
,	@Command varchar(max) = '\\Eehsql1\mssqlserver\FxEDI\RawEDIData\SupplierEDI_TestMailBox\FTPCommands\SendOutbound_v3_TestMailBox.cmd'
...
execute
	@ProcReturn = FTP.usp_SendSupplierEDI_TestMailBox
	@TranDT = @TranDT out
,	@Result = @ProcResult out
