...
/*
Create function TableFunction.FxEDI.RAWEDIDATA_FS.udf_DIR.sql
*/

use FxEDI
go

if	objectproperty(object_id('RAWEDIDATA_FS.udf_DIR'), 'IsTableFunction') = 1 begin
	drop function RAWEDIDATA_FS.udf_DIR
end
go
