...
/*
Create function TableFunction.FxEDI.RAWEDIDATA_FS.udf_DIR_Summary.sql
*/

use FxEDI
go

if	objectproperty(object_id('RAWEDIDATA_FS.udf_DIR_Summary'), 'IsTableFunction') = 1 begin
	drop function RAWEDIDATA_FS.udf_DIR_Summary
end
go
