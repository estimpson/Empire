...
/*
Create Procedure.FxEDI.RAWEDIDATA_FS.usp_FileMove.sql
*/

use FxEDI
go

if	objectproperty(object_id('RAWEDIDATA_FS.usp_FileMove'), 'IsProcedure') = 1 begin
	drop procedure RAWEDIDATA_FS.usp_FileMove
end
go
