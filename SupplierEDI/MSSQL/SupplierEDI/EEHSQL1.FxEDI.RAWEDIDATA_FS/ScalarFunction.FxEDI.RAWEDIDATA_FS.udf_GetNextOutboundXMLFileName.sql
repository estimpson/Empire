...
/*
Create ScalarFunction.FxEDI.RAWEDIDATA_FS.udf_GetNextOutboundXMLFileName.sql
*/

use FxEDI
go

if	objectproperty(object_id('RAWEDIDATA_FS.udf_GetNextOutboundXMLFileName'), 'IsScalarFunction') = 1 begin
	drop function RAWEDIDATA_FS.udf_GetNextOutboundXMLFileName
end
go
