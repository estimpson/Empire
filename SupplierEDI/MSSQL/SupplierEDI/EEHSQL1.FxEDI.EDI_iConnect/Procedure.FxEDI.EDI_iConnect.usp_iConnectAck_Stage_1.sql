...
/*
Create Procedure.FxEDI.EDI_iConnect.usp_iConnectAck_Stage_1.sql
*/

use FxEDI
go

if	objectproperty(object_id('EDI_iConnect.usp_iConnectAck_Stage_1'), 'IsProcedure') = 1 begin
	drop procedure EDI_iConnect.usp_iConnectAck_Stage_1
end
go
