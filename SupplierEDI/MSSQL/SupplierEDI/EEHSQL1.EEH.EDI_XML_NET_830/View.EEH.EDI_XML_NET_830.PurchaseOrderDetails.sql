...
/*
Create View.EEH.EDI_XML_NET_830.PurchaseOrderDetails.sql
*/

use EEH
go

--drop table EDI_XML_NET_830.PurchaseOrderDetails
if	objectproperty(object_id('EDI_XML_NET_830.PurchaseOrderDetails'), 'IsView') = 1 begin
	drop view EDI_XML_NET_830.PurchaseOrderDetails
end
go
