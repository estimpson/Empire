...
/*
Create ScalarFunction.EEH.EDI_XML_NET_830.Get830_valid.sql
*/

use EEH
go

if	objectproperty(object_id('EDI_XML_NET_830.Get830_valid'), 'IsScalarFunction') = 1 begin
	drop function EDI_XML_NET_830.Get830_valid
end
go

create function EDI_XML_NET_830.Get830_valid
...
select
	EDI_XML_NET_830.Get830_valid('PSG', '52721,48236', '05', 1)
