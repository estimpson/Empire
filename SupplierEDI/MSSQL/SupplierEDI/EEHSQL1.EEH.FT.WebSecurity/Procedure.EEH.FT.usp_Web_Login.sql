...
/*
Create Procedure.EEH.FT.usp_Web_Login.sql
*/

use EEH
go

if	objectproperty(object_id('FT.usp_Web_Login'), 'IsProcedure') = 1 begin
	drop procedure FT.usp_Web_Login
end
go
...
exec FT.usp_Web_Login
	@OperatorCode = 'EESTP'			 -- varchar(5)
,	@Password = '9646'				 -- varchar(5)
