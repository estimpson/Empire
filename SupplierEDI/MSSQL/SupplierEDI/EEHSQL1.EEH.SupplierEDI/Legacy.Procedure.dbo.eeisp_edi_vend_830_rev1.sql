alter procedure dbo.eeisp_edi_vend_830_rev1
as
------------------------------------------------------------------------------------
-- eeisp_edi_vend_830
...
-- 10/13/2015 - Now eliminates TE --Andre S. Boulanger FT, LLC
------------------------------------------------------------------------------------
...
where	edi_vendor.auto_create_po = 'Y' and
	...
	edi_vendor.trading_partner_code not in ( 'ARROWCORP', 'TTI','MCMASTERS', '3M', 'GPOLYMER', 'PSG', 'NEXEO', 'DELFINGEN', 'ARROW', 'FUTURE', 'KOSTAL', 'TE')
