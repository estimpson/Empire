...
/*
Create Procedure.EEH.SupplierEDI.usp_GetPurchaseOrderList.sql
*/

use EEH
go

if	objectproperty(object_id('SupplierEDI.usp_GetPurchaseOrderList'), 'IsProcedure') = 1 begin
	drop procedure SupplierEDI.usp_GetPurchaseOrderList
end
go

create procedure SupplierEDI.usp_GetPurchaseOrderList
...
execute
	@ProcReturn = SupplierEDI.usp_GetPurchaseOrderList
...
exec
	SupplierEDI.usp_GetPurchaseOrderList