alter procedure dbo.eeisp_edi_vend_830_rev1_PIONEER as
begin
------------------------------------------------------------------------------------
-- eeisp_edi_vend_830
...
--08/12/2008 - Added MCMASTERS to select list - Andre S. Boulanger
----01/10/2012 - Added NEXEO and PSG to select list - Andre S. Boulanger
--04/04/2012 - Added KOSTAL to select list - Andre S. Boulanger
------------------------------------------------------------------------------------
...
where   edi_vendor.auto_create_po = 'Y' and
	...
	upper(edi_vendor.trading_partner_code) in( 'ARROWCORP', 'TTI','MCMASTERS', '3M', 'GPOLYMER', 'PSG', 'NEXEO', 'DELFINGEN', 'ARROW', 'FUTURE', 'KOSTAL')
